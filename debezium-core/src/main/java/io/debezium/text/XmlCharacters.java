...
public class XmlCharacters {
    ...
    /**
     * This implementation uses an array that captures for each character the XML classifications. An array is used
     * because it is a fast way of looking up each character.
     */
    ...
    /**
     * Determine whether the supplied character is a valid first character in an XML Name. The first character in an XML
     * name is more restrictive than the {@link #isValidName(int) remaining characters}.
     *
     * @param c
     *            the character
     * 
    ...
    /**
     * Determine whether the supplied character is a valid first character in an XML NCName. The first character in an
     * XML NCName is more restrictive than the {@link #isValidName(int) remaining characters}.
     *
     * @param c
     *            the character
     * 
    ...
    /**
     * Determine whether the supplied character is a valid non-first character in an XML Name. The
     * {@link #isValidNameStart(int) first character} in an XML name is more restrictive than the remaining characters.
     *
     * @param c
     *            the character
     * 
     ...
     * {@link #isValidNcNameStart(int) first character} in an XML NCName is more restrictive than the remaining
     * characters.
     *
     * @param c
     *            the character
