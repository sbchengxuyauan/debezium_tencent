 ...
 */
public class CdcSourceTaskContext { // task 任务上下文对象
    ...
    public String[] capturedDataCollections() {
        return collectionsSupplier.get().stream().map(DataCollectionId::toString).toArray(String[]::new);
    }
