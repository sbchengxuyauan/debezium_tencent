...
public abstract class LegacyV1AbstractSourceInfoStructMaker<T extends AbstractSourceInfo>
    ...
    public LegacyV1AbstractSourceInfoStructMaker(String connector, String version,
    ...
    protected Struct commonStruct() {
        return new Struct(schema()).put(DEBEZIUM_VERSION_KEY, version).put(DEBEZIUM_CONNECTOR_KEY, connector);
    }
}
