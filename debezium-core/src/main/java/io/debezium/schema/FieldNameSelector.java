...
public class FieldNameSelector {
    ...
    private static class FieldNameSanitizer<T> implements FieldNamer<T> {
        ...
        /**
         * Sanitize column names that are illegal in Avro Must conform to
         * https://avro.apache.org/docs/1.7.7/spec.html#Names Legal characters are [a-zA-Z_] for the first character and
         * [a-zA-Z0-9_] thereafter.
         *
         * @param columnName
         *            the column name name to be sanitized
         *
        ...
        private String sanitizeColumnName(String columnName) {
            ...
            if (changed) {
                LOGGER.warn("Field '{}' name potentially not safe for serialization, replaced with '{}'", columnName,
                        sanitizedName);
            }
