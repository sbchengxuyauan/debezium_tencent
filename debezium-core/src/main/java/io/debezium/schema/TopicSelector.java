...
public class TopicSelector<I extends DataCollectionId> {
    ...
    private TopicSelector(String prefix, String heartbeatPrefix, String delimiter,
    ...
    public static <I extends DataCollectionId> TopicSelector<I> defaultSelector(String prefix, String heartbeatPrefix,
            String delimiter, DataCollectionTopicNamer<I> dataCollectionTopicNamer) {
     ...
     *
     * @param id
     *            the data collection identifier, never {@code null}
     * 
     ...
     */
    /**
     * Get the name of the heartbeat topic for the given server. This method returns "{@code <prefix>-heartbeat}".
     *
     * @return the topic name; never null
     */
    ...
    private static class TopicNameSanitizer<I extends DataCollectionId> implements DataCollectionTopicNamer<I> {
        ...
        public String topicNameFor(I id, String prefix, String delimiter) {
            ...
            if (changed) {
                ...
                LOGGER.warn("Topic '{}' name isn't a valid topic name, replacing it with '{}'.", topicName,
                        sanitizedName);
