...
/**
 * A stopwatch for measuring durations. All NewStopwatch implementations are threadsafe, although using a single
 * stopwatch object across threads requires caution and care.
 *
...
public abstract class Stopwatch {
     ...
     * reflect the most recently completed stopwatch interval.
     * <p>
     ...
     * <p>
     * This set is threadsafe, meaning that multiple threads can {@link #create()} new stopwatches concurrently, and
     * each stopwatch's duration is measured separately. Additionally, all of the other methods of this interface are
     * also threadsafe.
     * </p>
     */
    @ThreadSafe
    public static interface StopwatchSet extends Durations {
         ...
         *
         * @param runnable
         *            the function that is to be executed; may not be null
         * 
         ...
         * @param runnable
         *            the function to call; may not be null
         */
         ...
         *            the number of times to repeat the function call; must be positive
         * @param runnable
         *            the function that is to be executed a number of times; may not be null
         * @param cleanup
         ...
         * 
         * @throws Exception
         *             the exception thrown by the runnable function
         */
        ...
        /**
         * Block until all running stopwatches have been {@link Stopwatch#stop() stopped}. This means that if a
         * stopwatch is {@link #create() created} but never started, this method will not wait for it. Likewise, if a
         * stopwatch is {@link #create() created} and started, then this method will block until the stopwatch is
         * {@link Stopwatch#stop() stopped} (even if the same stopwatch is started multiple times). are stopped.
         *
         * @throws InterruptedException
         *             if the thread is interrupted before unblocking
         */
        void await() throws InterruptedException;

        /**
         * Block until all stopwatches that have been {@link #create() created} and {@link Stopwatch#start() started}
         * are stopped.
         *
         * @param timeout
         *            the maximum length of time that this method should block
         * @param unit
         *            the unit for the timeout; may not be null
         * 
         * @throws InterruptedException
         *             if the thread is interrupted before unblocking
         */
    ...
    /**
     * Create a new stopwatch that updates the given {@link BaseDurations duration}, and optionally has functions to be
     * called after the stopwatch is started and stopped.
     * <p>
     * The resulting stopwatch is threadsafe.
     * </p>
     *
     * @param duration
     *            the duration that should be updated; may not be null
     * @param uponStart
     *            the function that should be called when the stopwatch is successfully started (after not running); may
     *            be null
     * @param uponStop
     *            the function that should be called when the stopwatch is successfully stopped (after it was running);
     *            may be null
     * 
