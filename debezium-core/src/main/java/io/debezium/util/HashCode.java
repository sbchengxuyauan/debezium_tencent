...
/**
 * Utilities for easily computing hash codes. The algorithm should generally produce good distributions for use in
 * hash-based containers or collections, but as expected does always result in repeatable hash codes given the inputs.
 */
@Immutable
public class HashCode {
     ...
     *
     * @param seed
     *            a value upon which the hash code will be based; may be 0
     * @param objects
     *            the objects that should be used to compute the hash code
     * 
     * @return the hash code
