...
public class Iterators {
    ...
    public static <T, U, V> Iterator<V> around(Iterable<? extends T> first, Iterable<? extends U> second,
            BiFunction<T, U, V> conversion) {
        return around(first.iterator(), second.iterator(), conversion);
    }

    public static <T, U, V> Iterator<V> around(final Iterator<? extends T> first, final Iterator<? extends U> second,
     ...
     *
     * @param <F>
     *            the source transform type
     * @param <T>
     *            the destination transform type
     */
     ...
     *            the source iterator
     * @param function
     *            the function to be applied when performing element transformation
     *
     * @param <F>
     *            the source transform type
     * @param <T>
    ...
    /**
     * A read only iterator that is able to preview the next value without consuming it or altering the behavior or
     * semantics of the normal {@link Iterator} methods.
     *
     * @param <T>
     *            the type of value
     */
    public static interface PreviewIterator<T> extends Iterator<T> {
        /**
         * Peek at the next value without consuming or using it. This method returns the same value if called multiple
         * times between {@link Iterator#next}.
         *
