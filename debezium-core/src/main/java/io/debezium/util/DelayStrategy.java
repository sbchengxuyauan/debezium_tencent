...
public interface DelayStrategy {
     ...
     *
     * @param criteria
     *            {@code true} if this method should sleep, or {@code false} if there is no need to sleep
     * 
    ...
    /**
     * Create a delay strategy that applies a constant delay as long as the criteria is met. As soon as the criteria is
     * not met, the delay resets to zero.
     *
    ...
    /**
     * Create a delay strategy that applies an linearly-increasing delay as long as the criteria is met. As soon as the
     * criteria is not met, the delay resets to zero.
     *
     * @param delayInMilliseconds
     *            the initial delay; must be positive
     * 
