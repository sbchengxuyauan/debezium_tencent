...
public interface ElapsedTimeStrategy {
     ...
     *
     * @param clock
     *            the clock used to determine if sufficient time has elapsed; may not be null
     * @param delayInMilliseconds
     *            the time period; must be positive
     * 
     * @return the strategy; never null
     */
     ...
     * @param clock
     *            the clock used to determine if sufficient time has elapsed; may not be null
     * @param preStepDelayInMilliseconds
     *            the time period before the step has occurred; must be positive
     * @param stepFunction
     *            the function that determines if the step time has elapsed; may not be null
     * @param postStepDelayInMilliseconds
     *            the time period before the step has occurred; must be positive
     * 
     * @return the strategy; never null
     */
    public static ElapsedTimeStrategy step(Clock clock, long preStepDelayInMilliseconds, BooleanSupplier stepFunction,
     ...
     *            the maximum delay; must be greater than the initial delay
     * @param multiplier
     *            the factor by which the delay increases each pass
     * 
     * @return the strategy
     */
    public static ElapsedTimeStrategy exponential(Clock clock, long initialDelayInMilliseconds,
            long maxDelayInMilliseconds, double multiplier) {
        if (multiplier <= 1.0) {
