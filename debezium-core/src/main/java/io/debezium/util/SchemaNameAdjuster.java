...
public interface SchemaNameAdjuster {
     ...
     *
     * @param proposedName
     *            the proposed fullname; may not be null
     * 
    ...
    public static interface ReplacementOccurred {
         ...
         * @param conflictsWithOriginal
         *            the other original value that resulted in the same replacement; may be null if there is no
         *            conflict
         */
         ...
         *
         * @param next
         *            the function to call after this function; may be null
         * 
         * @return the new function; never null
         */
    ...
    /**
     * Create a stateful Avro fullname adjuster that logs a warning the first time an invalid fullname is seen and
     * replaced with a valid fullname and throws an exception. This method replaces all invalid characters with the
    ...
    /**
     * Create a stateful Avro fullname adjuster that logs a warning the first time an invalid fullname is seen and
     * replaced with a valid fullname, and throws an error if the replacement conflicts with that of a different
     * original. This method replaces all invalid characters with the underscore character ('_').
     *
     * @param logger
     *            the logger to use; may not be null
     * 
     * @return the validator; never null
     */
    ...
    /**
     * Create a stateful Avro fullname adjuster that logs a warning the first time an invalid fullname is seen and
     * replaced with a valid fullname. This method replaces all invalid characters with the underscore character ('_').
     *
     * @param logger
     *            the logger to use; may not be null
     * @param uponConflict
     *            the function to be called when there is a conflict and after that conflict is logged; may be null
     * 
     * @return the validator; never null
     */
    ...
    /**
     * Create a stateful Avro fullname adjuster that calls the supplied {@link ReplacementOccurred} function when an
     * invalid fullname is seen and replaced with a valid fullname. This method replaces all invalid characters with the
     * underscore character ('_').
     *
     * @param uponReplacement
     *            the function called each time the original fullname is replaced; may be null
     * 
    ...
    /**
     * Create a stateful Avro fullname adjuster that calls the supplied {@link ReplacementOccurred} function when an
     * invalid fullname is seen and replaced with a valid fullname.
     *
     * @param replacement
     *            the character that should be used to replace all invalid characters
     * @param uponReplacement
     *            the function called each time the original fullname is replaced; may be null
     * 
     * @return the adjuster; never null
     ...
     *
     * @param replacement
     *            the character sequence that should be used to replace all invalid characters
     * @param uponReplacement
     *            the function called each time the original fullname is replaced; may be null
     * 
     * @return the adjuster; never null
     ...
     *
     * @param fullname
     *            the name to be used as an Avro fullname; may not be null
     * 
     ...
     *            the character
     * 
     * @return {@code true} if the character is a valid non-first character of an Avro fullname, or {@code false}
     *         otherwise
     * 
     * @see #isValidFullname(String)
     */
    ...
    /**
     * Convert the proposed string to a valid Avro fullname, using the supplied function to replace all invalid
     * characters.
     *
     * @param proposedName
     *            the proposed fullname; may not be null
     ...
     *            the character sequence that should be used to replace all invalid characters
     * @param uponReplacement
     *            the function to be called every time the proposed name is invalid and replaced; may be null
     * 
     * @return the valid fullname for Avro; never null
     */
    public static String validFullname(String proposedName, ReplacementFunction replacement,
            ReplacementOccurred uponReplacement) {
