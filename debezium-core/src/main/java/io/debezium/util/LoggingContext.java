...
/**
 * A utility that provides a consistent set of properties for the Mapped Diagnostic Context (MDC) properties used by
 * Debezium components.
 *
...
public class LoggingContext {
    ...
    /**
     * Configure for a connector the logger's Mapped Diagnostic Context (MDC) properties for the thread making this
     * call.
     *
     * @param connectorType
     *            the type of connector; may not be null
     * @param connectorName
     *            the name of the connector; may not be null
     * @param contextName
     ...
     *            the type of connector; may not be null
     * @param connectorName
     *            the logical name of the connector; may not be null
     * @param contextName
     *            the name of the context; may not be null
     * @param operation
     ...
     *             if any of the parameters are null
     */
    public static void temporarilyForConnector(String connectorType, String connectorName, String contextName,
            Runnable operation) {
        if (connectorType == null) {
            throw new IllegalArgumentException("The MDC value for the connector type may not be null");
        }
