 ...
 * {@link #from(Properties) from Properties} or loaded from a {@link #load(File) file}, {@link #load(InputStream)
 * stream}, {@link #load(Reader) reader}, {@link #load(URL) URL}, or {@link #load(String, ClassLoader) classpath
 * resource}. They can also be built by first {@link #create() creating a builder} and then using that builder to
 * populate and {@link Builder#build() return} the immutable Configuration instance.
 * <p>
 * A Configuration object is basically a decorator around a {@link Properties} object. It has methods to get and convert
 * individual property values to numeric, boolean and String types, optionally using a default value if the given
 * property value does not exist. However, it is {@link Immutable immutable}, so it does not have any methods to set
 * property values, allowing it to be passed around and reused without concern that other components might change the
...
public interface Configuration {
    ...
    public static final Pattern PASSWORD_PATTERN = Pattern.compile(".*password$|.*sasl\\.jaas\\.config$",
    ...
    public static interface ConfigBuilder<C extends Configuration, B extends ConfigBuilder<C, B>> {
        ...
        /**
         * If there is no field with the specified key, then associate the given class name value with the specified
         * key.
         *
         * @param key
         *            the key
         ...
         *
         * @param other
         *            the configuration whose fields should be added; may not be null
         * 
         * @return this builder object so methods can be chained together; never null
         */
         ...
         *
         * @param field
         *            the predefined field for the key
         * @param value
         *            the value
         * 
         * @return this builder object so methods can be chained together; never null
         ...
         *            the key
         * @param function
         *            the function that computes the new value given a possibly-existing value; may not be null
         * 
         * @return this builder object so methods can be chained together; never null
         * 
         * @throws NumberFormatException
         *             if the existing value is not a boolean
         */
         ...
         * 
         * @throws NumberFormatException
         *             if the existing value is not a double
         */
         ...
         * 
         * @throws NumberFormatException
         *             if the existing value is not a float
         */
         ...
         * 
         * @throws NumberFormatException
         *             if the existing value is not a long
         */
         ...
         * 
         * @throws NumberFormatException
         *             if the existing value is not an integer
         */
     ...
     *
     * @param prefix
     *            the required prefix for the system properties; may not be null but may be empty
     * 
    ...
    /**
     * Obtain a configuration instance by copying the supplied Properties object. The supplied {@link Properties} object
     * is copied so that the resulting Configuration cannot be modified.
     *
     * @param properties
     *            the properties; may be null or empty
     * 
    ...
    /**
     * Obtain a configuration instance by copying the supplied map of string keys and object values. The entries within
     * the map are copied so that the resulting Configuration cannot be modified.
     *
     * @param properties
     *            the properties; may be null or empty
     * 
     ...
     *            the properties; may be null or empty
     * @param conversion
     *            the function that converts the supplied values into strings, or returns {@code null} if the value is
     *            to be excluded
     * 
     * @return the configuration; never null
     */
     ...
     *
     * @param url
     *            the URL to the stream containing the configuration properties; may not be null
     * 
     * @return the configuration; never null
     * 
     * @throws IOException
     ...
     *
     * @param file
     *            the file containing the configuration properties; may not be null
     * 
     * @return the configuration; never null
     * 
     * @throws IOException
     ...
     *
     * @param stream
     *            the stream containing the properties; may not be null
     * 
     * @return the configuration; never null
     * 
     * @throws IOException
     ...
     *
     * @param reader
     *            the reader containing the properties; may not be null
     * 
     * @return the configuration; never null
     * 
     * @throws IOException
    ...
    /**
     * Obtain a configuration instance by loading the Properties from a file on the file system or classpath given by
     * the supplied path.
     *
     * @param path
     *            the path to the file containing the configuration properties; may not be null
     * @param clazz
     *            the class whose classpath is to be used to find the file; may be null
     * 
     ...
     *            the class loader to use; may be null
     * @param logger
     *            the function that will be called with status updates; may be null
     * 
     * @return the configuration; never null but possibly empty
     * 
     * @throws IOException
    ...
    /**
     * Get the string value associated with the given key, returning the default value if there is no such key-value
     * pair.
     *
     * @param key
     *            the key for the configuration property
     * @param defaultValue
     *            the value that should be returned by default if there is no such key-value pair in the configuration;
     *            may be null
     * 
     * @return the configuration value, or the {@code defaultValue} if there is no such key-value pair in the
     *         configuration
     */
     ...
     *            the supplier of value that should be returned by default if there is no such key-value pair in the
     *            configuration; may be null and may return null
     * 
     * @return the configuration value, or the {@code defaultValue} if there is no such key-value pair in the
     *         configuration
     */
    ...
    /**
     * Get the string value associated with the given field, returning the field's default value if there is no such
     * key-value pair in this configuration.
     *
     * @param field
     *            the field; may not be null
     * 
     * @return the configuration's value for the field, or the field's {@link Field#defaultValue() default value} if
     *         there is no such key-value pair in the configuration
     */
    ...
    /**
     * Get the string value(s) associated with the given key, where the supplied regular expression is used to parse the
     * single string value into multiple values.
     *
     * @param field
     *            the field; may not be null
     * @param regex
     ...
     *            the key for the configuration property
     * 
     * @return the integer value, or null if the key is null, there is no such key-value pair in the configuration, or
     ...
     *            the key for the configuration property
     * 
     * @return the boolean value, or null if the key is null, there is no such key-value pair in the configuration, or
     *         the value could not be parsed as a boolean value
     */
    ...
    /**
     * Get the integer value associated with the given key, returning the default value if there is no such key-value
     * pair or if the value could not be {@link Integer#parseInt(String) parsed} as an integer.
     *
     * @param key
     *            the key for the configuration property
     * @param defaultValue
    ...
    /**
     * Get the long value associated with the given key, returning the default value if there is no such key-value pair
     * or if the value could not be {@link Long#parseLong(String) parsed} as a long.
     *
     * @param key
     *            the key for the configuration property
     * @param defaultValue
     *            the default value
     * 
     * @return the long value, or null if the key is null, there is no such key-value pair in the configuration, or the
     *         value could not be parsed as a long
     */
    ...
    /**
     * Get the boolean value associated with the given key, returning the default value if there is no such key-value
     * pair or if the value could not be {@link Boolean#parseBoolean(String) parsed} as a boolean value.
     *
     * @param key
     *            the key for the configuration property
     * @param defaultValue
    ...
    /**
     * Get the integer value associated with the given key, using the given supplier to obtain a default value if there
     * is no such key-value pair.
     *
     * @param key
     *            the key for the configuration property
     * @param defaultValueSupplier
     *            the supplier for the default value; may be null
     * 
     * @return the integer value, or null if the key is null, there is no such key-value pair in the configuration, the
     *         {@code defaultValueSupplier} reference is null, or there is a key-value pair in the configuration but the
    ...
    /**
     * Get the long value associated with the given key, using the given supplier to obtain a default value if there is
    ...
    /**
     * Get the boolean value associated with the given key, using the given supplier to obtain a default value if there
     * is no such key-value pair.
     *
     * @param key
     *            the key for the configuration property
     ...
     *         {@code defaultValueSupplier} reference is null, or there is a key-value pair in the configuration but the
     *         value could not be parsed as a boolean value
     */
     ...
     *            the field
     * 
     * @return the integer value, or null if the key is null, there is no such key-value pair in the configuration and
     *         there is no default value in the field or the default value could not be parsed as a long, or there is a
     *         key-value pair in the configuration but the value could not be parsed as an integer value
     * 
     * @throws NumberFormatException
     *             if there is no name-value pair and the field has no default value
     */
     ...
     * @return the integer value, or null if the key is null, there is no such key-value pair in the configuration and
     *         there is no default value in the field or the default value could not be parsed as a long, or there is a
     *         key-value pair in the configuration but the value could not be parsed as a long value
     * 
     * @throws NumberFormatException
     *             if there is no name-value pair and the field has no default value
     */
    ...
    /**
     * Get the boolean value associated with the given field when that field has a default value. If the configuration
     * does not have a name-value pair with the same name as the field, then the field's default value.
     *
     * @param field
     *            the field
     * 
     * @return the boolean value, or null if the key is null, there is no such key-value pair in the configuration and
     *         there is no default value in the field or the default value could not be parsed as a long, or there is a
     *         key-value pair in the configuration but the value could not be parsed as a boolean value
     * 
     * @throws NumberFormatException
     *             if there is no name-value pair and the field has no default value
     */
     ...
     *            the field
     * @param unit
     *            the temporal unit of the duration value
     * 
     ...
     *            the key for the configuration property
     * @param type
     *            the Class of which the resulting object is expected to be an instance of; may not be null
     * 
     * @return the new instance, or null if there is no such key-value pair in the configuration or if there is a
     *         key-value configuration but the value could not be converted to an existing class with a zero-argument
     *         constructor
     */
     ...
     * @param type
     *            the Class of which the resulting object is expected to be an instance of; may not be null
     * @param classloaderSupplier
     *            the supplier of the ClassLoader to be used to load the resulting class; may be null if this class'
    ...
    /**
     * Get an instance of the class given by the value in the configuration associated with the given key. The instance
     * is created using {@code Instance(Configuration)} constructor.
     *
     * @param key
     *            the key for the configuration property
     * @param clazz
     *            the Class of which the resulting object is expected to be an instance of; may not be null
     * @param the
     *            {@link Configuration} object that is passed as a parameter to the constructor
     * 
     * @return the new instance, or null if there is no such key-value pair in the configuration or if there is a
     *         key-value configuration but the value could not be converted to an existing class with a zero-argument
     *         constructor
     ...
     *
     * @param field
     *            the field for the configuration property
     * @param clazz
     *            the Class of which the resulting object is expected to be an instance of; may not be null
     * 
     * @return the new instance, or null if there is no such key-value pair in the configuration or if there is a
    ...
    /**
     * Get an instance of the class given by the value in the configuration associated with the given field. The
     * instance is created using {@code Instance(Configuration)} constructor.
     *
     * @param field
     *            the field for the configuration property
     * @param clazz
    ...
    /**
     * Return a new {@link Configuration} that contains only the subset of keys that match the given prefix. If desired,
     * the keys in the resulting Configuration will have the prefix (plus any terminating "{@code .}" character if
     * needed) removed.
     * <p>
     ...
     *            the prefix
     * @param removePrefix
     *            true if the prefix (and any subsequent "{@code .}" character) should be removed from the keys in the
     *            resulting Configuration, or false if the keys in this Configuration should be used as-is in the
     ...
     *
     * @param mapper
     *            that function that transforms keys
     * 
     ...
     *
     * @param matcher
     *            the function that determines whether a key should be included in the subset
     * 
     * @return the subset Configuration; never null
     */
    default Configuration filter(Predicate<? super String> matcher) {
        ...
        return new Configuration() {
            @Override
            public Set<String> keys() {
                return Collect.unmodifiableSet(Configuration.this.keys().stream().filter(k -> k != null).filter(matcher)
     ...
     *
     * @param mapper
     *            the function that takes a key and value and returns the new mapped value
     * 
     ...
     * variables in the fields replaced with values from the supplied function. Variables found in fields will be left
     * as-is if the supplied function returns no value for the variable name(s).
     * <p>
     * Variables may appear anywhere within a field value, and multiple variables can be used within the same field.
     ...
     * until an existing property is found. And at that point, it will stop and will not attempt to find values for the
     * other <i>variables</i>.
     * <p>
     *
     *
     * @param valuesByVariableName
     *            the function that returns a variable value for a variable name; may not be null but may return null if
    ...
    /**
     * Return a new {@link Configuration} that contains all of the same fields as this configuration, except with masked
     * values for all keys that end in "password".
     *
     * @return the Configuration with masked values for matching keys; never null
     */
    ...
    /**
     * Return a new {@link Configuration} that contains all of the same fields as this configuration, except with masked
     * values for all keys that match the specified pattern.
     *
     * @param keyRegex
     *            the regular expression to match against the keys
     * 
     * @return the Configuration with masked values for matching keys; never null
     */
     ...
     *
     * @param fields
     *            the fields defining the defaults; may be null
     * 
     * @return the properties object; never null
     */
    ...
    /**
     * Return a copy of this configuration except where acceptable system properties are used to overwrite properties
     * copied from this configuration. All system properties whose name has the given prefix are added, where the prefix
     * is removed from the system property name, it is converted to lower case, and each underscore character
     * ('{@code _}') are replaced with a period ('{@code .}').
     *
     * @param prefix
     *            the required prefix for the system properties
     * 
    ...
    /**
     * Return a copy of this configuration except where acceptable system properties are used to overwrite properties
     * copied from this configuration. Each of the system properties is examined and passed to the supplied function; if
     * the result of the function is a non-null string, then a property with that string as the name and the system
     * property value are added to the returned configuration.
     *
     * @param propertyNameConverter
     *            the function that will convert the name of each system property to an applicable property name (or
     *            null if the system property name does not apply); may not be null
     * 
    ...
    /**
     * Validate the supplied fields in this configuration. Extra fields not described by the supplied {@code fields}
     * parameter are not validated.
     *
     * @param fields
     *            the fields
     * @param problems
     *            the consumer to be called with each problem; never null
     * 
     ...
     *
     * @param regex
     *            the regular expression string; may not be null
     * @param function
     *            the consumer that takes the name and value of matching fields; may not be null
     */
    ...
    /**
     * For all fields whose names match the given regular expression, extract an integer from the first group in the
     * regular expression and call the supplied function.
     *
     * @param regex
     *            the regular expression string; may not be null
     * @param function
     *            the consumer that takes the value of matching field and the integer extracted from the field name; may
     *            not be null
     */
     ...
     *            the regular expression string; may not be null
     * @param groupNumber
     *            the number of the regular expression group containing the integer to be extracted; must be positive
     * @param function
     *            the consumer that takes the value of matching field and the integer extracted from the field name; may
     *            not be null
     */
    default <T> void forEachMatchingFieldNameWithInteger(String regex, int groupNumber,
     ...
     *            not be null
     */
    default <T> void forEachMatchingFieldNameWithInteger(Pattern regex, int groupNumber,
            BiConsumer<String, Integer> function) {
        BiFunction<String, String, Integer> extractor = (fieldName, strValue) -> {
            try {
                ...
                LoggerFactory.getLogger(getClass()).error(
                        "Unexpected value {} extracted from configuration field '{}' using regex '{}'", strValue,
                        fieldName, regex);
                return null;
            }
        };
    ...
    /**
     * For all fields whose names match the given regular expression, extract a boolean value from the first group in
     * the regular expression and call the supplied function.
     *
     * @param regex
     *            the regular expression string; may not be null
     * @param function
     *            the consumer that takes the value of matching field and the boolean extracted from the field name; may
     *            not be null
     */
     ...
     *            the regular expression string; may not be null
     * @param groupNumber
     *            the number of the regular expression group containing the boolean to be extracted; must be positive
     * @param function
     *            the consumer that takes the value of matching field and the boolean extracted from the field name; may
     *            not be null
     */
    default <T> void forEachMatchingFieldNameWithBoolean(String regex, int groupNumber,
     ...
     *            not be null
     */
    default <T> void forEachMatchingFieldNameWithBoolean(Pattern regex, int groupNumber,
            BiConsumer<String, Boolean> function) {
    ...
    /**
     * For all fields whose names match the given regular expression, extract a string value from the first group in the
     * regular expression and call the supplied function.
     *
     * @param regex
     *            the regular expression string; may not be null
     * @param function
     *            the consumer that takes the value of matching field and the string value extracted from the field
     ...
     *            the regular expression string; may not be null
     * @param groupNumber
     *            the number of the regular expression group containing the string value to be extracted; must be
     *            positive
     * @param function
     *            the consumer that takes the value of matching field and the string value extracted from the field
     *            name; may not be null
     */
    default <T> void forEachMatchingFieldNameWithString(String regex, int groupNumber,
     ...
     *            name; may not be null
     */
    default <T> void forEachMatchingFieldNameWithString(Pattern regex, int groupNumber,
            BiConsumer<String, String> function) {
        forEachMatchingFieldName(regex, groupNumber, (fieldName, value) -> value, function);
    }

    /**
     * For all fields whose names match the given regular expression, extract a value from the specified group in the
     * regular expression and call the supplied function.
     *
     * @param regex
     *            the regular expression string; may not be null
     ...
     *            the function that extracts the value from the group
     * @param function
     *            the consumer that takes the value of matching field and the value extracted from the field name; may
     *            not be null
     */
    default <T> void forEachMatchingFieldName(String regex, int groupNumber,
            BiFunction<String, String, T> groupExtractor, BiConsumer<String, T> function) {
     ...
     *            not be null
     */
    default <T> void forEachMatchingFieldName(Pattern regex, int groupNumber,
            BiFunction<String, String, T> groupExtractor, BiConsumer<String, T> function) {
        this.asMap().forEach((fieldName, fieldValue) -> {
     ...
     *
     * @param function
     *            the consumer that takes the field name and the string value extracted from the field; may not be null
     */
