...
public class Instantiator {
    ...
    /**
     * Instantiates the specified class either using the no-args constructor or the constructor with a single parameter
     * of type {@link Configuration}, if a configuration object is passed.
     *
