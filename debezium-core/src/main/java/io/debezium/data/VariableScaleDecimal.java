...
public class VariableScaleDecimal {
    ...
    /**
     * Returns a {@link SchemaBuilder} for a VariableScaleDecimal. You can use the resulting SchemaBuilder to set
     * additional schema settings such as required/optional, default value, and documentation.
     *
     * @return the schema builder
     */
    public static SchemaBuilder builder() {
        return SchemaBuilder.struct().name(LOGICAL_NAME).version(1).doc("Variable scaled decimal")
                .field(SCALE_FIELD, Schema.INT32_SCHEMA).field(VALUE_FIELD, Schema.BYTES_SCHEMA);
    }
    ...
    /**
     * Converts a value from its logical format to its encoded format - a struct containing the scale of the number and
     * a binary representation of the number.
     *
     * @param schema
     *            of the encoded value
     * @param value
     *            the value or the decimal
     *
