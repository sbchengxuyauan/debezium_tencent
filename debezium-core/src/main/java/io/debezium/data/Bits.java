...
public class Bits {
    ...
    /**
     * Returns a {@link SchemaBuilder} for a Bits. You can use the resulting SchemaBuilder to set additional schema
     * settings such as required/optional, default value, and documentation.
     *
     * @param length
     *            maximum the number of bits in the set
     * 
     * @return the schema builder
     */
    public static SchemaBuilder builder(int length) {
        return SchemaBuilder.bytes().name(LOGICAL_NAME).parameter(LENGTH_FIELD, Integer.toString(length)).version(1);
    }
