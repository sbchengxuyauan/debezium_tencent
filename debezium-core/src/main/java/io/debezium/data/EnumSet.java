...
/**
 * A semantic type for a set of enumerated values, where the string values contain comma-separated values from an
 * enumeration.
 *
...
public class EnumSet {
    ...
    /**
     * Returns a {@link SchemaBuilder} for a set of enumerated values. You can use the resulting SchemaBuilder to set
     * additional schema settings such as required/optional, default value, and documentation.
     *
     * @param allowedValues
     *            the comma separated list of allowed values; may not be null
     * 
     * @return the schema builder
     */
    public static SchemaBuilder builder(String allowedValues) {
        return SchemaBuilder.string().name(LOGICAL_NAME).parameter(VALUES_FIELD, allowedValues).version(1);
    }
