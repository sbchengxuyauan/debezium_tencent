...
/**
 * Extension of plain a {@link BigDecimal} type that adds support for new features like special values handling - NaN,
 * infinity;
 *
...
public class SpecialValueDecimal implements Serializable {
     ...
     *
     * @param decimal
     *            a string containing valid decimal number
     * 
     ...
     *
     * @param mode
     *            the mode in which the number should be encoded
     * @param precision
    ...
    public static Object fromLogical(SpecialValueDecimal value, DecimalMode mode, String columnName) {
        ...
        default:
            throw new ConnectException("Got a special value (NaN/Infinity) for Decimal type in column " + columnName
                    + " but current mode does not handle it. "
