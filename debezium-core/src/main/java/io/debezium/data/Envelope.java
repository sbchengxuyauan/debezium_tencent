...
/**
 * An immutable descriptor for the structure of Debezium message envelopes. An {@link Envelope} can be created for each
 * message schema using the {@link #defineSchema()} builder, and once created can generate {@link Struct} objects
 * representing CREATE, READ, UPDATE, and DELETE messages that conform to that schema.
 *
...
public final class Envelope {
    ...
    public static final class FieldName {
        ...
        /**
         * The {@code origin} field is used to store the information about the source of a record, including the Kafka
         * Connect partition and offset information.
         */
         ...
         * processed/generated the event. The timestamp values are the number of milliseconds past epoch (January 1,
         * 1970), and determined by the {@link System#currentTimeMillis() JVM current time in milliseconds}. Note that
         * the <em>accuracy</em> of the timestamp value depends on the JVM's system clock and all of its assumptions,
         * limitations, conditions, and variations.
         */
    ...
    public static interface Builder {
         ...
         *
         * @param schema
         *            the schema of the records, used in the {@link FieldName#BEFORE} and {@link FieldName#AFTER}
         ...
         *
         * @param sourceSchema
         *            the schema of the {@link FieldName#SOURCE} field; may not be null
         * 
         * @return this builder so methods can be chained; never null
         */
         ...
         *
         * @param fieldNames
         *            the names of the fields that this schema should be used with; may not be null
         * @param fieldSchema
         *            the schema of the new optional field; may not be null
         * 
         * @return this builder so methods can be chained; never null
         */
    ...
    public static Builder defineSchema() {
        return new Builder() {
            ...
            public Envelope build() {
                builder.field(FieldName.OPERATION,
                        OPERATION_REQUIRED ? Schema.STRING_SCHEMA : Schema.OPTIONAL_STRING_SCHEMA);
                ...
                if (!missingFields.isEmpty()) {
                    throw new IllegalStateException(
                            "The envelope schema is missing field(s) " + String.join(", ", missingFields));
                }
     ...
     *
     * @param record
     *            the state of the record as read; may not be null
     * @param source
     *            the information about the source that was read; may be null
     * @param timestamp
     *            the timestamp for this message; may be null
     * 
     ...
     *
     * @param record
     *            the state of the record after creation; may not be null
     * @param source
     *            the information about the source where the creation occurred; may be null
     * @param timestamp
     *            the timestamp for this message; may be null
     * 
     ...
     *
     * @param before
     *            the state of the record before the update; may be null
     * @param after
     *            the state of the record after the update; may not be null
     * @param source
     *            the information about the source where the update occurred; may be null
     * @param timestamp
     *            the timestamp for this message; may be null
     * 
     ...
     *
     * @param before
     *            the state of the record before the delete; may be null
     * @param source
     *            the information about the source where the deletion occurred; may be null
     * @param timestamp
     *            the timestamp for this message; may be null
     * 
