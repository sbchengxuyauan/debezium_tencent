...
public class ExtractNewRecordStateConfigDefinition {
    ...
    public static enum DeleteHandling implements EnumeratedValue {
        DROP("drop"), REWRITE("rewrite"), NONE("none");
    ...
    public static final Field DROP_TOMBSTONES = Field.create("drop.tombstones").withDisplayName("Drop tombstones")
    ...
    public static final Field HANDLE_DELETES = Field.create("delete.handling.mode")
            .withDisplayName("Handle delete records").withEnum(DeleteHandling.class, DeleteHandling.DROP)
            .withWidth(ConfigDef.Width.MEDIUM).withImportance(ConfigDef.Importance.MEDIUM)
            .withDescription("How to handle delete records. Options are: " + "none - records are passed,"
                    + "drop - records are removed (the default)," + "rewrite - __deleted field is added to records.");
    ...
    public static final Field OPERATION_HEADER = Field.create("operation.header")
            ...
            .withDescription("DEPRECATED. Please use the 'add.fields' option instead. "
                    + "Adds the operation type of the change event as a header." + "Its key is '"
    ...
    public static final Field ROUTE_BY_FIELD = Field.create("route.by.field")
            .withDisplayName(
                    "The column which determines how the events will be routed, the value will replace the topic name.")
    ...
    public static final Field ADD_SOURCE_FIELDS = Field.create("add.source.fields")
            ...
            .withType(ConfigDef.Type.LIST).withWidth(ConfigDef.Width.LONG).withImportance(ConfigDef.Importance.LOW)
            .withDefault("")
            .withDescription("DEPRECATED. Please use the 'add.fields' option instead. "
    ...
    public static final Field ADD_FIELDS = Field.create("add.fields")
            .withDisplayName("Adds the specified field(s) to the message if they exist.").withType(ConfigDef.Type.LIST)
            .withWidth(ConfigDef.Width.LONG).withImportance(ConfigDef.Importance.LOW).withDefault("")
    ...
    public static final Field ADD_HEADERS = Field.create("add.headers")
            .withDisplayName("Adds the specified fields to the header if they exist.").withType(ConfigDef.Type.LIST)
            .withWidth(ConfigDef.Width.LONG).withImportance(ConfigDef.Importance.LOW).withDefault("")
