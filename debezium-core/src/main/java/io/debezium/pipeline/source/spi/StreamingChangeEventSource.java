...
public interface StreamingChangeEventSource extends ChangeEventSource {
    ...
    /**
     * Commits the given offset with the source database. Used by some connectors like Postgres and Oracle to indicate
     * how far the source TX log can be discarded.
     */
