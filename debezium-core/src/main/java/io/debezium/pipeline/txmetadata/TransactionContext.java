...
/**
 * The context holds internal state necessary for book-keeping of events in active transaction. The main data tracked
 * are
 * <ul>
...
public class TransactionContext {
    ...
    private static final String OFFSET_TRANSACTION_ID = TransactionMonitor.DEBEZIUM_TRANSACTION_KEY + "_"
            + TransactionMonitor.DEBEZIUM_TRANSACTION_ID_KEY;
