 ...
 * thread-safe since they are expected to be used within a thread-safe process, and sent across a network to another
 * thread-safe process where they will be merged together.
 *
...
public final class CRDT {
    ...
    /**
     * Create a new CRDT grow-only (G) counter pre-populated with the given value. The operations on this counter are
     * not threadsafe.
     *
     * @param adds
     *            the number of adds
    ...
    /**
     * Create a new CRDT positive and negative (PN) counter pre-populated with the given values. The operations on this
     * counter are not threadsafe.
     *
     * @param adds
     *            the number of adds
     * @param removes
    ...
    /**
     * Create a new CRDT positive and negative (PN) counter that records how much the value has changed since last
     * reset. The operations on this counter are not threadsafe.
     *
     * @return the new counter; never null
     */
     ...
     *
     * @param totalAdds
     *            the total number of adds
     * @param totalRemoves
     *            the total number of removes
     * @param recentAdds
     *            the recent number of adds since last {@link DeltaCounter#reset()}
     * @param recentRemoves
     *            the recent number of removes since last {@link DeltaCounter#reset()}
     * 
     * @return the new counter; never null
     */
     ...
     *
     * @param count
     *            the {@link DeltaCount} instance that should be used to pre-populate the new counter; may be null
     * 
     * @return the new counter; never null
     */
