 ...
 * <em>nanoseconds</em> since midnight, and for defining a Kafka Connect {@link Schema} for time values with no date or
...
public class NanoTime {
    ...
    /**
     * Returns a {@link SchemaBuilder} for a {@link NanoTime}. The resulting schema will describe a field with the
     ...
     * literal type storing the number of <em>nanoseconds</em> past midnight.
     *
     * @return the schema
     * 
     * @see #builder()
