 ...
 * representation of the time and date in a particular time zone, and for defining a Kafka Connect {@link Schema} for
 * zoned timestamp values.
 * <p>
...
public class ZonedTimestamp {
    ...
    /**
     * Returns a {@link SchemaBuilder} for a {@link ZonedTimestamp}. You can use the resulting SchemaBuilder to set
    ...
    public static String toIsoString(Object value, ZoneId defaultZone, TemporalAdjuster adjuster) {
        ...
        throw new IllegalArgumentException("Unable to convert to OffsetDateTime from unexpected value '" + value
