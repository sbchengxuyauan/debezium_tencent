...
/**
 * A utility for converting various Java time representations into the {@link SchemaBuilder#string() STRING}
 * representation of the time in a particular time zone, and for defining a Kafka Connect {@link Schema} for zoned time
 * values.
 * <p>
...
public class ZonedTime {
    ...
    /**
     * Returns a {@link SchemaBuilder} for a {@link ZonedTime}. You can use the resulting SchemaBuilder to set
    ...
    /**
     * Get the ISO 8601 formatted representation of the given {@link java.time.LocalDateTime},
     * {@link java.time.LocalDate}, {@link java.time.LocalTime}, {@link java.util.Date}, {@link java.sql.Date},
     * {@link java.sql.Time}, {@link java.sql.Timestamp}, {@link OffsetTime}, or {@link OffsetDateTime}, ignoring any
     * date portions of the supplied value.
     *
     * @param value
     *            the local or SQL date, time, or timestamp value; may not be null
     * @param defaultZone
     *            the time zone that should be used by default if the value does not have timezone information; may not
     *            be null
     * @param adjuster
     ...
     *             if the value is not an instance of the acceptable types or is null
     */
    public static String toIsoString(Object value, ZoneId defaultZone, TemporalAdjuster adjuster) {
        ...
        throw new IllegalArgumentException("Unable to convert to OffsetTime from unexpected value '" + value
     ...
     *
     * @param timestamp
     *            the timestamp value; may not be null
     * @param adjuster
     *            the optional component that adjusts the local date value before obtaining the epoch day; may be null
     *            if no adjustment is necessary
     * 
    ...
    /**
     * Get the ISO 8601 formatted representation of the given {@link java.util.Date} or one of its JDBC subclasses,
     * using the supplied timezone information.
     *
     * @param timestamp
     *            the timestamp value; may not be null
     * @param zoneId
     *            the timezone identifier or offset where the timestamp is defined
     * @param adjuster
     *            the optional component that adjusts the local date value before obtaining the epoch day; may be null
     *            if no adjustment is necessary
     * 
    ...
    /**
     * Get the ISO 8601 formatted representation of the given {@link java.sql.Timestamp}, which contains a date and time
     * but has no timezone information.
     *
     * @param timestamp
     *            the JDBC timestamp value; may not be null
     * @param zoneId
     *            the timezone identifier or offset where the timestamp is defined
     * @param adjuster
     *            the optional component that adjusts the local date value before obtaining the epoch day; may be null
    ...
    /**
     * Get the ISO 8601 formatted representation of the given {@link java.sql.Date}, which contains a date but no time
     * or timezone information.
     *
     * @param date
     *            the date value; may not be null
     * @param zoneId
     *            the timezone identifier or offset where the date is defined
     * @param adjuster
     *            the optional component that adjusts the local date value before obtaining the epoch day; may be null
     *            if no adjustment is necessary
     * 
    ...
    /**
     * Get the ISO 8601 formatted representation of the given {@link java.sql.Time}, which contains time but no date or
     * timezone information.
     *
     * @param time
     *            the JDBC time value; may not be null
     * @param zoneId
     *            the timezone identifier or offset where the time is defined
     * @param adjuster
     *            the optional component that adjusts the local date value before obtaining the epoch day; may be null
     *            if no adjustment is necessary
     * 
