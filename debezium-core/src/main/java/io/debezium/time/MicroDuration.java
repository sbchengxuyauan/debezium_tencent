...
/**
 * A utility representing a duration into a corresponding {@link SchemaBuilder#int64() INT64} number of
 * <em>microsecond</em>, and for defining a Kafka Connect {@link Schema} for duration values.
 *
...
public class MicroDuration {
    ...
    /**
     * Returns a {@link SchemaBuilder} for a {@link MicroDuration}. The resulting schema will describe a field with the
     * {@value #SCHEMA_NAME} as the {@link Schema#name() name} and {@link SchemaBuilder#float64()} FLOAT64} for the
     * literal type storing the number of <em>microseconds</em> for that duration.
     * <p>
    ...
    /**
     * Returns a Schema for a {@link MicroDuration} but with all other default Schema settings. The schema describes a
     * field with the {@value #SCHEMA_NAME} as the {@link Schema#name() name} and {@link SchemaBuilder#float64()}
     * FLOAT64} for the literal type storing the number of <em>microseconds</em>.
     *
     * @return the schema
     * 
     * @see #builder()
     ...
     * @param daysPerMonthAvg
     *            an optional value representing a days per month average; if null, the default duration from
     *            {@link ChronoUnit#MONTHS} is used.
     * 
