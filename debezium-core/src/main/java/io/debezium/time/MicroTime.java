 ...
 * <em>microseconds</em> since midnight, and for defining a Kafka Connect {@link Schema} for time values with no date or
...
public class MicroTime {
    ...
    /**
     * Returns a {@link SchemaBuilder} for a {@link MicroTime}. The resulting schema will describe a field with the
     ...
     * literal type storing the number of <em>microseconds</em> past midnight.
     *
     * @return the schema
     * 
     * @see #builder()
