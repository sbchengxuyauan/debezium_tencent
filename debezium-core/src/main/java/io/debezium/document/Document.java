...
/**
 * A document contains multiple {@link Field}s, each with a name and possibly-null {@link Value}. A single document can
 * only contain a single field with a given name.
 *
...
public interface Document extends Iterable<Document.Field>, Comparable<Document> {
    ...
    static Document create(CharSequence fieldName1, Object value1, CharSequence fieldName2, Object value2,
            CharSequence fieldName3, Object value3) {
        return new BasicDocument().set(fieldName1, value1).set(fieldName2, value2).set(fieldName3, value3);
    }

    static Document create(CharSequence fieldName1, Object value1, CharSequence fieldName2, Object value2,
            CharSequence fieldName3, Object value3, CharSequence fieldName4, Object value4) {
        return new BasicDocument().set(fieldName1, value1).set(fieldName2, value2).set(fieldName3, value3)
                .set(fieldName4, value4);
    }

    static Document create(CharSequence fieldName1, Object value1, CharSequence fieldName2, Object value2,
            CharSequence fieldName3, Object value3, CharSequence fieldName4, Object value4, CharSequence fieldName5,
            Object value5) {
        return new BasicDocument().set(fieldName1, value1).set(fieldName2, value2).set(fieldName3, value3)
                .set(fieldName4, value4).set(fieldName5, value5);
    }

    static Document create(CharSequence fieldName1, Object value1, CharSequence fieldName2, Object value2,
            CharSequence fieldName3, Object value3, CharSequence fieldName4, Object value4, CharSequence fieldName5,
            Object value5, CharSequence fieldName6, Object value6) {
        return new BasicDocument().set(fieldName1, value1).set(fieldName2, value2).set(fieldName3, value3)
                .set(fieldName4, value4).set(fieldName5, value5).set(fieldName6, value6);
    }
    ...
    /**
     * Set the value at the given path resolved against this document, optionally adding any missing intermediary
     * documents or arrays based upon the format of the path segments.
     *
     * @param path
     *            the path at which the value is to be set
     * @param addIntermediaries
     *            true if any missing intermediary fields should be created, or false if any missing intermediary fields
     *            should be handled as an error via {@code invalid}
     * @param value
     *            the value that should be set at the given path; may be null or a {@link Value#nullValue() null value}
     * @param invalid
     *            the function that should be called if the supplied path cannot be resolved; may not be null
     * 
     * @return the {@code value} if successful or the {@link Optional#empty() empty (not present)} optional value if the
     *         path was invalid and could not be resolved (and {@code invalid} is invoked)
     */
    default Optional<Value> set(Path path, boolean addIntermediaries, Value value, Consumer<Path> invalid) {
        ...
        if (!addIntermediaries) {
            ...
            parent = find(parentPath, (missingPath, missingIndex) -> {
                String nextSegment = path.segment(missingIndex + 1); // can always find next segment 'path' (not
                                                                     // 'parentPath')...
     ...
     *            the path to find
     * 
     * @return the optional value at this path, which is {@link Optional#isPresent() present} if the value was found at
     *         that path or is {@link Optional#empty() empty (not present)} if there is no value at the path or if the
     *         path was not valid
     */
     ...
     *            function called when a segment in the path does not exist, and which should return a new value if one
     *            should be created or {@link Optional#empty()} if nothing should be created and {@code invalid}
     *            function should be called by this method
     * @param invalid
     *            function called when the supplied path is invalid; in this case, this method also returns
     *            {@link Optional#empty()}
     * 
     * @return the optional value at this path, which is {@link Optional#isPresent() present} if the value was found at
     *         that path or is {@link Optional#empty() empty (not present)} if there is no value at the path or if the
     *         path was not valid
     */
    default Optional<Value> find(Path path, BiFunction<Path, Integer, Optional<Value>> missingSegment,
     ...
     *
     * @param path
     *            the path to the contained document
     * 
    ...
    /**
     * Find the document at the given field name and obtain a stream over its fields. This will return an empty stream
     * when:
     * <ul>
     ...
     *            The name of the field
     * @param defaultValue
     *            the default value to return if there is no such field
     * 
     ...
     *            The name of the field
     * @param defaultValue
     *            the default value to return if there is no such field or if the value is not a boolean
     * 
     * @return The boolean field value if found, or <code>defaultValue</code> if there is no such field or if the value
     *         is not a boolean
     */
     ...
     *            The name of the field
     * @param defaultValue
     *            the default value to return if there is no such field or if the value is not a integer
     * 
     * @return The integer field value if found, or <code>defaultValue</code> if there is no such field or if the value
     *         is not a integer
     */
     ...
     *            The name of the field
     * @param defaultValue
     *            the default value to return if there is no such field or if the value is not a long value
     * 
     * @return The long field value if found, or <code>defaultValue</code> if there is no such field or if the value is
     *         not a long value
     */
     ...
     *            The name of the field
     * @param defaultValue
     *            the default value to return if there is no such field or if the value is not a double
     * 
     * @return The double field value if found, or <code>defaultValue</code> if there is no such field or if the value
     *         is not a double
     */
     ...
     *            The name of the field
     * @param defaultValue
     *            the default value to return if there is no such field or if the value is not a number
     * 
     * @return The number field value if found, or <code>defaultValue</code> if there is no such field or if the value
     *         is not a number
     */
     ...
     *            The name of the field
     * 
     * @return The big integer field value, if found, or null if there is no such field or if the value is not a big
     *         integer
     */
     ...
     *            The name of the field
     * @param defaultValue
     *            the default value to return if there is no such field or if the value is not a big integer
     * 
     * @return The big integer field value, if found, or null if there is no such field or if the value is not a big
     *         integer
     */
     ...
     *            The name of the field
     * 
     * @return The big decimal field value, if found, or null if there is no such field or if the value is not a big
     *         decimal
     */
     ...
     *            The name of the field
     * @param defaultValue
     *            the default value to return if there is no such field or if the value is not a big decimal
     * 
     * @return The big decimal field value, if found, or null if there is no such field or if the value is not a big
     *         decimal
     */
     ...
     *            The name of the field
     * @param defaultValue
     *            the default value to return if there is no such field or if the value is not a string
     * 
     * @return The string field value if found, or <code>defaultValue</code> if there is no such field or if the value
     *         is not a string
     */
     ...
     *            The name of the field
     * 
     * @return The array field value (as a list), if found, or null if there is no such field or if the value is not an
     *         array
     */
     ...
     *            The name of the field
     * @param defaultValue
     *            the default array that should be returned if there is no such field
     * 
     * @return The array field value (as a list), if found, or the default value if there is no such field or if the
    ...
    /**
     * Get the existing array value in this document for the given field name, or create a new array if there is no
     * existing array at this field.
     *
     * @param fieldName
     *            The name of the field
     * 
    ...
    /**
     * Get the existing document value in this document for the given field name, or create a new document if there is
     * no existing document at this field.
     *
     * @param fieldName
     *            The name of the field
     * 
    ...
    /**
     * Determine whether this object has a field with the given the name and the value is null. This is equivalent to
     * calling:
     *
     * <pre>
    ...
    /**
     * Determine whether this object has a field with the given the name and the value is null, or if this object has no
     ...
     *
     * @param fields
     *            the name/value pairs to be set on this object; may not be null
     * 
     * @return This document, to allow for chaining methods
     */
     ...
     * @param fields
     *            the name/value pairs to be set on this object; may not be null
     * @param acceptableFieldNames
     *            the predicate to determine which fields from the source should be copied; may not be null
     * 
     * @return This document, to allow for chaining methods
     */
    ...
    /**
     * Set the value for the field with the given name to be a null value. The {@link #isNull(CharSequence)} methods can
     * be used to determine if a field has been set to null, or {@link #isNullOrMissing(CharSequence)} if the field has
     * not be set or if it has been set to null.
     *
     * @param name
     *            The name of the field
     * 
     ...
     *            The name of the field
     * @param increment
     *            the amount to increment the existing value; may be negative to decrement
     * 
     ...
     *            The name of the field
     * @param document
     *            the document; if null, a new document will be created
     * 
     * @return The document that was just set as the value for the named field; never null and may or may not be the
     *         same instance as the supplied <code>document</code>.
     */
     ...
     *
     * @param that
     *            the other Document to be compared to this object
     * 
    ...
    /**
     * Compare this Document to the specified Document, without regard to the order of the fields and only using the
     * fields that are in both documents.
     *
     * @param that
     *            the other Document to be compared to this object
     * 
     ...
     * @param that
     *            the other Document to be compared to this object
     * @param enforceFieldOrder
     *            {@code true} if the documents should be compared using their existing field order, or {@code false} if
     *            the field order should not affect the result.
     * 
     * @return a negative integer, zero, or a positive integer as this object is less than, equal to, or greater than
     *         the specified object.
     */
