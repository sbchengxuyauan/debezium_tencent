...
public interface DocumentWriter {
     ...
     * 
     * @param document
     *            the document to be written; may not be null
     * 
     ...
     * 
     * @param document
     *            the array to be written; may not be null
     * @param jsonStream
     *            the stream to which the document is to be written; may not be null
     * 
     * @throws IOException
     ...
     *            the array to be written; may not be null
     * @param jsonWriter
     *            the writer to which the document is to be written; may not be null
     * 
     * @throws IOException
     *             if a document could not be written to the supplied stream
     */
