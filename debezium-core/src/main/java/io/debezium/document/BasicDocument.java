...
final class BasicDocument implements Document {
    ...
    /**
     * Semantically compare two values. This includes comparing numeric values of different types (e.g., an integer and
     * long), and {@code null} and {@link Value#nullValue()} references.
     *
     * @param value1
    ...
    /**
     * Semantically compare two non-null values. This includes comparing numeric values of different types (e.g., an
     * integer and long), but excludes {@code null} and {@link Value#nullValue()} references.
     *
     * @param value1
     *            the first value; may be null
     * @param value2
