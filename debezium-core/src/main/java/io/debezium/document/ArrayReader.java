...
public interface ArrayReader {
     ...
     *
     * @param jsonStream
     *            the input stream to be read; may not be null
     * 
     ...
     *
     * @param jsonReader
     *            the reader to be read; may not be null
     * 
     * @return the array instance; never null
     * 
     * @throws IOException
     ...
     *
     * @param json
     *            the JSON string representation to be read; may not be null
     * 
     * @return the array instance; never null
     * 
     * @throws IOException
     ...
     *
     * @param jsonUrl
     *            the URL to the content that is to be read; may not be null
     * 
     * @return the array instance; never null
     * 
     * @throws IOException
     ...
     *
     * @param jsonFile
     *            the file to be read; may not be null
     * 
     * @return the array instance; never null
     * 
     * @throws IOException
     ...
     *
     * @param rawBytes
     *            the UTF-8 bytes to be read; may not be null
     * 
     * @return the array instance; never null
     * 
     * @throws IOException
