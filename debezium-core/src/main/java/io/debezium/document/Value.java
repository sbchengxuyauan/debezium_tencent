 ...
 * to perform semantic comparisons, use {@link #comparable()} to obtain a wrapped value with semantic comparison
 * capability.
 *
...
public interface Value extends Comparable<Value> {
    ...
    static boolean isValid(Object value) {
        return value == null || value instanceof Value || value instanceof String || value instanceof Boolean
                || value instanceof Integer || value instanceof Long || value instanceof Float
                || value instanceof Double || value instanceof Document || value instanceof Array
     ...
     *
     * @param value1
     *            the first value object, may be null
     * @param value2
     *            the second value object, which may be null
     * 
     * @return a negative integer if the first value is less than the second, zero if the values are equivalent
     *         (including if both are null), or a positive integer if the first value is greater than the second
     */
    ...
    /**
     * Get a Value representation that will allow semantic comparison of values, rather than the literal comparison
     * normally performed by {@link #compareTo}.
     *
     ...
     *
     * @param consumer
     *            block to be executed if the value is a document
     * 
     ...
     *
     * @param consumer
     *            block to be executed if the value is an array
     * 
     * @return true if the block was called, or false otherwise
     */
     ...
     *
     * @param consumer
     *            block to be executed if the value is a string
     * 
     * @return true if the block was called, or false otherwise
     */
     ...
     *
     * @param consumer
     *            block to be executed if the value is a boolean
     * 
     * @return true if the block was called, or false otherwise
     */
     ...
     *
     * @param consumer
     *            block to be executed if the value is a byte array
     * 
     * @return true if the block was called, or false otherwise
     */
     ...
     *
     * @param consumer
     *            block to be executed if the value is an integer
     * 
     * @return true if the block was called, or false otherwise
     */
     ...
     *
     * @param consumer
     *            block to be executed if the value is a long
     * 
     * @return true if the block was called, or false otherwise
     */
     ...
     *
     * @param consumer
     *            block to be executed if the value is a float
     * 
     * @return true if the block was called, or false otherwise
     */
     ...
     *
     * @param consumer
     *            block to be executed if the value is a double
     * 
     * @return true if the block was called, or false otherwise
     */
     ...
     *
     * @param consumer
     *            block to be executed if the value is a big integer
     * 
     * @return true if the block was called, or false otherwise
     */
     ...
     *
     * @param consumer
     *            block to be executed if the value is a big decimal
     * 
     * @return true if the block was called, or false otherwise
     */
