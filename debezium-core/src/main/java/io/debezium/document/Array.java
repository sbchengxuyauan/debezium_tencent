...
/**
 * An array of {@link Value}s. The array can also be viewed as a stream of {@link Entry} instances, each of which
 * contain the index and the value.
 *
...
public interface Array extends Iterable<Array.Entry>, Comparable<Array> {
     ...
     *            the index
     * @param defaultValue
     *            the default value to return if there is no such entry
     * 
    ...
    /**
     * Determine whether this object has an entry at the given index and the value is null, or if this object has no
     ...
     *
     * @param values
     *            the values to be added to this array
     * 
     * @return this array to allow for chaining methods
     */
     ...
     *
     * @param value
     *            the string value; may be null if a {@link #addNull() null value} should be added
     * 
     * @return this array to allow for chaining methods
     */
     ...
     *
     * @param value
     *            the boolean value; may not be null
     * 
     * @return this array to allow for chaining methods
     */
     ...
     *
     * @param value
     *            the boolean value; may be null if a {@link #addNull() null value} should be added
     * 
     * @return this array to allow for chaining methods
     */
    default Array add(Boolean value) {
     ...
     *
     * @param value
     *            the integer value; may not be null
     * 
     * @return this array to allow for chaining methods
     */
     ...
     *
     * @param value
     *            the long value; may not be null
     * 
     * @return this array to allow for chaining methods
     */
     ...
     *
     * @param value
     *            the float value; may not be null
     * 
     * @return this array to allow for chaining methods
     */
     ...
     *
     * @param value
     *            the double value; may not be null
     * 
     * @return this array to allow for chaining methods
     */
     ...
     *
     * @param value
     *            the big integer value; may be null if a {@link #addNull() null value} should be added
     * 
     * @return this array to allow for chaining methods
     */
     ...
     *
     * @param value
     *            the decimal value; may be null if a {@link #addNull() null value} should be added
     * 
     * @return this array to allow for chaining methods
     */
     ...
     *
     * @param value
     *            the integer value; may be null if a {@link #addNull() null value} should be added
     * 
     * @return this array to allow for chaining methods
     */
     ...
     *
     * @param value
     *            the long value; may be null if a {@link #addNull() null value} should be added
     * 
     * @return this array to allow for chaining methods
     */
    default Array add(Long value) {
     ...
     *
     * @param value
     *            the float value; may be null if a {@link #addNull() null value} should be added
     * 
     * @return this array to allow for chaining methods
     */
    default Array add(Float value) {
     ...
     *
     * @param value
     *            the double value; may be null if a {@link #addNull() null value} should be added
     * 
     * @return this array to allow for chaining methods
     */
    default Array add(Double value) {
     ...
     *
     * @param value
     *            the document value; may be null if a {@link #addNull() null value} should be added
     * 
     * @return this array to allow for chaining methods
     */
     ...
     *
     * @param value
     *            the array value; may be null if a {@link #addNull() null value} should be added
     * 
     * @return this array to allow for chaining methods
     */
     ...
     *
     * @param entries
     *            the entries that are to be used to modify this array
     * 
     * @return this array to allow for chaining methods
     */
    ...
    /**
     * Set the value for the field with the given name to be a null value. The {@link #isNull(int)} methods can be used
     * to determine if a field has been set to null, or {@link #isNullOrMissing(int)} if the field has not be set or if
     * it has been set to null.
     *
     * @param index
     *            the index of the field; must be greater than or equal to 0 or less than or equal to {@link #size()
     *            size}
     * 
     * @return this array to allow for chaining methods
     * 
     ...
     *
     * @param index
     *            the index of the field; must be greater than or equal to 0 and less than or equal to {@link #size()
     *            size}
     * @param value
     *            the new value
     * 
    ...
    /**
     * If the current size of the array is smaller than the given size, expand it and use a null value for all new
     * entries. This method does nothing if the current size is larger than the supplied {@code desiredSize}.
     *
     * @param desiredSize
     *            the desired size of the array; may be negative
     * 
     * @return this array to allow for chaining methods
     */
    ...
    /**
     * If the current size of the array is smaller than the given size, expand it and use the supplied value for all new
     * entries. This method does nothing if the current size is larger than the supplied {@code desiredSize}.
     *
     * @param desiredSize
     *            the desired size of the array; may be negative
     * @param value
     *            the new value for any new entries
     * 
     * @return this array to allow for chaining methods
     */
