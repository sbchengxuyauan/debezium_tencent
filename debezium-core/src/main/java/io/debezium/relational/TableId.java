...
public final class TableId implements DataCollectionId, Comparable<TableId> {
     ...
     *
     * @param str
     *            the string representation of the table identifier; may not be null
     * 
    ...
    public static TableId parse(String str, boolean useCatalogBeforeSchema) {
        String[] parts = TableIdParser.parse(str).stream().toArray(String[]::new);
     ...
     *
     * @param parts
     *            the parts of the identifier; may not be null
     * @param numParts
     *            the number of parts to use for the table identifier
     * @param useCatalogBeforeSchema
     *            {@code true} if the parsed string contains only 2 items and the first should be used as the catalog
     *            and the second as the table name, or {@code false} if the first should be used as the schema and the
     *            second as the table name
    ...
    /**
     * Returns a dot-separated String representation of this identifier, quoting all name parts with the {@code "} char.
     */
    ...
    /**
     * Returns a dot-separated String representation of this identifier, quoting all name parts with the given quoting
     * char.
     */
