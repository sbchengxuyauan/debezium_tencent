...
public interface ValueConverter {
    ...
    /**
     * Adapt this converter to call the specified <em>fallback</em> converter when this converter returns {@code null}
     * for a non-null input.
     *
     * @param fallback
     *            the converter to fall back to when this converter returns {@code null} for a non-null input
     * 
     ...
     *
     * @param delegate
     *            the converter to call after this converter
     * 
