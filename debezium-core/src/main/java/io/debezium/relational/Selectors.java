...
/**
 * Define predicates determines whether tables or columns should be used. The predicates use rules to determine which
 * tables and columns are included or excluded.
 * <p>
 * Because tables can be included and excluded based upon their fully-qualified names and based upon the database names,
 * this class defines a {@link #tableSelector() builder} to collect the various regular expression patterns the
 * predicate(s) will use to determine which columns and tables are included. The builder is then used to
...
public class Selectors {
    ...
    public static class DatabaseSelectionPredicateBuilder {
         ...
         *
         * @param databaseNames
         *            the comma-separated list of database names to include; may be null or empty
         * 
         ...
         * {@link #excludeDatabases(String) excluded} databases, although {@link #includeDatabases(String) including
         * databases} overrides exclusions.
         *
         * @param databaseNames
         *            the comma-separated list of database names to exclude; may be null or empty
         * 
         * @return this builder so that methods can be chained together; never null
         */
    ...
    public static class TableSelectionPredicateBuilder {
         ...
         *
         * @param schemaNames
         *            the comma-separated list of schema names to include; may be null or empty
         * 
         * @return this builder so that methods can be chained together; never null
         */
        ...
        /**
         * Specify the names of the schemas that should be excluded. This method will override previously
         * {@link #excludeSchemas(String) excluded} schemas, although {@link #includeSchemas(String)} including schemas}
         * overrides exclusions.
         *
         * @param schemaNames
         *            the comma-separated list of schema names to exclude; may be null or empty
         * 
         * @return this builder so that methods can be chained together; never null
         */
         ...
         * <p>
         * Note that any specified tables that are in an {@link #excludeDatabases(String) excluded database} will not be
         * included.
         *
         * @param fullyQualifiedTableNames
         *            the comma-separated list of fully-qualified table names to include; may be null or empty
         * @param tableIdMapper
         *            an arbitrary converter used to convert TableId into String for pattern matching. Usually used to
         *            remove a component from tableId to simplify patterns.
         * 
         * @return this builder so that methods can be chained together; never null
         */
        public TableSelectionPredicateBuilder includeTables(String fullyQualifiedTableNames,
            ...
            if (isEmpty(fullyQualifiedTableNames)) {
                ...
                tableInclusions = Predicates.includes(fullyQualifiedTableNames,
                        tableId -> tableIdMapper.toString(tableId));
            }
         ...
         * {@link #excludeDatabases(String) excluded} tables, although {@link #includeTables(String) including tables}
         * overrides exclusions.
         * <p>
         * Note that any specified tables that are in an {@link #excludeDatabases(String) excluded database} will not be
         * included.
         *
         * @param fullyQualifiedTableNames
         *            the comma-separated list of fully-qualified table names to exclude; may be null or empty
         * @param tableIdMapper
         *            an arbitrary converter used to convert TableId into String for pattern matching. Usually used to
         *            remove a component from tableId to simplify patterns.
         * 
        ...
        public TableSelectionPredicateBuilder excludeTables(String fullyQualifiedTableNames,
            ...
            if (isEmpty(fullyQualifiedTableNames)) {
                ...
                tableExclusions = Predicates.excludes(fullyQualifiedTableNames,
                        tableId -> tableIdMapper.toString(tableId));
            }
        ...
        private Predicate<TableId> buildStartingFromSchemaFilter(Predicate<String> schemaFilter,
        ...
        private Predicate<TableId> buildStartingFromDbFilter(Predicate<String> dbFilter, Predicate<String> schemaFilter,
            ...
            if (schemaFilter != null) {
                if (tableFilter != null) {
                    return (id) -> dbFilter.test(id.catalog()) && schemaFilter.test(id.schema())
                            && tableFilter.test(id);
                } else {
                    return (id) -> schemaFilter.test(id.schema());
                }
