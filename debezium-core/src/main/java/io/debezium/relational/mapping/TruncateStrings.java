...
/**
 * A {@link ColumnMapper} implementation that ensures that string values longer than a specified length will be
 * truncated.
 *
...
public class TruncateStrings implements ColumnMapper {
     ...
     *
     * @param maxLength
     *            the maximum number of characters allowed in values
     * 
     * @throws IllegalArgumentException
     *             if the {@code maxLength} is not positive
     */
