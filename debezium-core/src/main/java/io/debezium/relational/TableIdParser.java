    ...
    private enum ParsingState {
        ...
        IN_IDENTIFIER {
            ...
            void doOnExit(ParsingContext context) {
                context.tokens.addToken(context.input.position(context.startOfLastToken), context.startOfLastToken,
        ...
        IN_QUOTED_IDENTIFIER {
            ...
            void doOnExit(ParsingContext context) {
                ...
                context.tokens.addToken(context.input.position(context.startOfLastToken + 1),
                        context.startOfLastToken + 1, context.lastIdentifierEnd);
            }
        };
