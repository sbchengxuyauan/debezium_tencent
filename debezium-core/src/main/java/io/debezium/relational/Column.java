...
public interface Column extends Comparable<Column> {
     ...
     *
     * @return the database-specific character set name, or null if the column's data type doesn't
     *         {@link #typeUsesCharset() use character sets} or no character set is specified
     */
    String charsetName();
