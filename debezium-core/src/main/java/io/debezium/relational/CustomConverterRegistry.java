...
public class CustomConverterRegistry {
        ...
        for (CustomConverter<SchemaBuilder, ConvertedField> converter : converters) {
            ...
            converter.converterFor(new RelationalColumn() {
                ...
                public OptionalInt length() {
                    return column.length() == Column.UNSET_INT_VALUE ? OptionalInt.empty()
                            : OptionalInt.of(column.length());
                }
    ...
    public Optional<ValueConverter> getValueConverter(TableId table, Column column) {
        final ConverterDefinition<SchemaBuilder> converterDefinition = conversionFunctionMap
                .get(fullColumnName(table, column));
     ...
     *
     * @param <S>
     *            schema describing the output type, usually {@link org.apache.kafka.connect.data.SchemaBuilder}
     */
