...
public interface ValueConverterProvider {
     ...
     *            the column definition; never null
     * 
    ...
    /**
     * Returns a {@link ValueConverter} that can be used to convert the JDBC values corresponding to the given JDBC
     * temporal type into literal values described by the {@link #schemaBuilder(Column) schema}.
     * <p>
     * This method is only called when {@link #schemaBuilder(Column)} returns a non-null {@link SchemaBuilder} for the
