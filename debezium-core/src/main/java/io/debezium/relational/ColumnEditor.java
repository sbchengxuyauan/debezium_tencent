...
public interface ColumnEditor {
     ...
     *
     * @return the database-specific character set name, or null if the column's data type doesn't use character sets or
     *         no character set is specified
     */
    String charsetName();

    /**
     * Get the database-specific name of the character set defined by this column's table, which is used if a character
    ...
    /**
     * Set the database-specific name of the column's data type. The expression includes the column's {@link #typeName()
     * type name} and also any dimensions, lengths, precisions, character sets, etc.
     *
     *
     * @param typeName
     *            the column's type name
     * @param typeExpression
     *            the column's complete type expression
     * 
     * @return this editor so callers can chain methods together
     */
     ...
     *
     * @param jdbcType
     *            {@link Types JDBC type} for this column
     * 
     * @return this editor so callers can chain methods together
     */
     ...
     *
     * @param charsetName
     *            the database-specific character set name; may be null
     * 
     * @return this editor so callers can chain methods together
     */
     ...
     *
     * @param scale
     *            the scale or {@code null} to unset
     * 
     * @return this editor so callers can chain methods together
     */
     ...
     *
     * @param optional
     *            {@code true} if the column's values are optional, or {@code false} otherwise
     * 
     * @return this editor so callers can chain methods together
     */
     ...
     *            {@code true} if the column's values are automatically incremented by the database, or {@code false}
     *            otherwise
     * 
     * @return this editor so callers can chain methods together
     */
     ...
     *
     * @param generated
     *            {@code true} if the column's values are generated by the database, or {@code false} otherwise
     * 
     * @return this editor so callers can chain methods together
     */
    ...
    /**
     * Obtain an immutable column definition representing the current state of this editor. Typically, an editor is
     * created and used to build a column, and then discarded. However, this editor with its current state can be reused
     * after this method, since the resulting column definition no longer refers to any of the data used in this editor.
     *
