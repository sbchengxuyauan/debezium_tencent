...
public interface Table {
    ...
    default List<Column> primaryKeyColumns() {
        List<Column> pkColumns = primaryKeyColumnNames().stream().map(this::columnWithName)
     ...
     *
     * @return the database-specific character set name used by default in columns of this table, or {@code null} if
     *         there is no such default character set name defined on the table
     */
     ...
     * 
     * @return {@code true} if a column exists in this table and it is part of the primary key, or {@code false}
     *         otherwise
     */
