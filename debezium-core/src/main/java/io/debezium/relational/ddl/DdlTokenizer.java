...
public class DdlTokenizer implements Tokenizer {
    ...
    /**
     * The {@link Token#type() token type} for tokens that represent an unquoted string containing a character sequence
     * made up of non-whitespace and non-symbol characters.
     */
    ...
    /**
     * The {@link Token#type() token type} for tokens that consist of all the characters within single-quotes. Single
     * quote characters are included if they are preceded (escaped) by a '\' character.
     */
    public static final int SINGLE_QUOTED_STRING = 8;
    /**
     * The {@link Token#type() token type} for tokens that consist of all the characters within double-quotes. Double
     * quote characters are included if they are preceded (escaped) by a '\' character.
     */
     ...
     * between "//" and the next line terminator (e.g., '\n', '\r' or "\r\n"), between "#" and the next line terminator
     * (e.g., '\n', '\r' or "\r\n"), or between "--" and the next line terminator (e.g., '\n', '\r' or "\r\n").
     */
    public static final int COMMENT = 32;

    /**
     * The {@link Token#type() token type} for tokens that represent key words or reserved words for a given DDL
     * dialect.
     * <p>
    ...
    /**
     * The {@link Token#type() token type} for tokens that represent the start of a DDL statement.
     * <p>
    ...
    protected Tokens adapt(CharacterStream input, Tokens output) {
