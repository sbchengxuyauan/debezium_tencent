...
/**
 * An interface that can listen to various actions of a {@link LegacyDdlParser}. Every kind of {@link Event} has a
 * {@link EventType type} that makes it easier to implement a {@link DdlParserListener} using a {@code switch}
 * statement. However, each kind of {@link Event} also may have additional data associated with it.
 * <p>
...
public interface DdlParserListener {
    ...
    public static enum EventType {
        CREATE_TABLE, ALTER_TABLE, DROP_TABLE, TRUNCATE_TABLE, CREATE_INDEX, DROP_INDEX, CREATE_DATABASE,
        ALTER_DATABASE, DROP_DATABASE, USE_DATABASE, SET_VARIABLE,
    }
