...
/**
 * {@link RuntimeException} which is raised for various {@link java.sql.SQLException} instances and which retains the
 * error code from the original exception.
 *
...
public final class JdbcConnectionException extends RuntimeException {
     ...
     *
     * @param e
     *            a {@link SQLException} instance, may not be null
     */
     ...
     *
     * @param message
     *            the exception message, may not be null
     * @param e
     *            a {@link SQLException} instance, may not be null
     */
