...
public enum TemporalPrecisionMode implements EnumeratedValue {
     ...
     * {@link io.debezium.time} semantic types. TIME fields will always be represented as microseconds in INT64 /
     * {@link java.lang.Long} using {@link io.debezium.time.MicroTime}
     */
    ADAPTIVE_TIME_MICROSECONDS("adaptive_time_microseconds"),

    /**
     * Represent time and date values using Kafka Connect {@link org.apache.kafka.connect.data} logical types, which
