...
public interface JdbcConfiguration extends Configuration {
     ...
     */
    public static final Field ON_CONNECT_STATEMENTS = Field.create("initial.statements",
            "A semicolon separated list of statements to be executed on connection");
     ...
     */
    public static Set<String> ALL_KNOWN_FIELDS = Collect.unmodifiableSet(Field::name, DATABASE, USER, PASSWORD,
            HOSTNAME, PORT, ON_CONNECT_STATEMENTS);
