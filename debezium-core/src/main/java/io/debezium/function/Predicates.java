...
public class Predicates {
    ...
    /**
     * Generate a predicate function that for any supplied UUID strings returns {@code true} if <i>any</i> of the
     * comma-separated UUID literals or regular expressions matches the predicate parameter. This supplied strings can
     * be a mixture of regular expressions and UUID literals, and the most efficient method will be used for each.
     *
     * @param uuidPatterns
     *            the comma-separated UUID literals or regular expression patterns; may not be null
     * 
     * @return the predicate function that performs the matching
     * 
     * @throws PatternSyntaxException
     *             if the string includes an invalid regular expression
     */
     ...
     * expressions or literals in the supplied comma-separated list matches the predicate parameter. This supplied
     * strings can be a mixture of regular expressions and UUID literals, and the most efficient method will be used for
     * each.
     *
     * @param uuidPatterns
     *            the comma-separated regular expression pattern (or literal) strings; may not be null
     * 
     * @return the predicate function that performs the matching
     * 
     * @throws PatternSyntaxException
    ...
    /**
     * Generate a predicate function that for any supplied string returns {@code true} if <i>any</i> of the regular
     * expressions or literals in the supplied comma-separated list matches the predicate parameter. This supplied
     * strings can be a mixture of regular expressions and literals, and the most efficient method will be used for
     * each.
     *
     * @param literalsOrPatterns
     *            the comma-separated regular expression pattern (or literal) strings; may not be null
     * @param isLiteral
     *            function that determines if a given pattern is a literal string; may not be null
     * @param conversion
     *            the function that converts each predicate-supplied value to a string that can be matched against the
     ...
     *
     * @param literals
     *            the comma-separated literal strings; may not be null
     * 
     * @return the predicate function that performs the matching
     */
    ...
    /**
     * Generate a predicate function that for any supplied parameter returns {@code true} if <i>any</i> of the regular
     * expressions in the supplied comma-separated list matches the predicate parameter in a case-insensitive manner.
     *
     * @param regexPatterns
     *            the comma-separated regular expression pattern (or literal) strings; may not be null
     * @param conversion
    ...
    protected static <T, U> BiPredicate<T, U> includedInPatterns(Collection<Pattern> patterns,
            BiFunction<T, U, String> conversion) {
        return (t, u) -> matchedByPattern(patterns, conversion).apply(t, u).isPresent();
    }

    /**
     * Generate a predicate function that for any supplied string returns a {@link Pattern} representing the first
     * regular expression in the supplied comma-separated list that matches the predicate parameter in a
    ...
    protected static <T> Function<T, Optional<Pattern>> matchedByPattern(Collection<Pattern> patterns,
            Function<T, String> conversion) {
        return (t) -> {
    ...
    protected static <T, U> BiFunction<T, U, Optional<Pattern>> matchedByPattern(Collection<Pattern> patterns,
            BiFunction<T, U, String> conversion) {
        return (t, u) -> {
    ...
    /**
     * Create a predicate function that allows only those values are allowed or not disallowed by the supplied
     * predicates.
     *
     * @param allowed
     *            the predicate that defines the allowed values; may be null
     * @param disallowed
     *            the predicate that defines the disallowed values; may be null
     * 
