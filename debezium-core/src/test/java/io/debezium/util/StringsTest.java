...
public class StringsTest {
    ...
    public void replaceVariablesShouldReplaceVariablesWithDefaultWhenNoReplacementIsFound() {
        ...
        assertReplacement("some ${var1,var2,var3:other} text", vars("var10", "replaced", "var11", "new"),
                "some other text");
    }
    ...
    public void replaceVariablesShouldReplaceMultipleVariables() {
        ...
        assertReplacement("some ${v1} text ${v2} end", vars("v1", "first", "v2", "second"),
                "some first text second end");
        assertReplacement("some ${v1:other} text", vars("vx1", "replaced"), "some other text");
        assertReplacement("some ${v1,v2,v3:other} text ${v1,v2,v3:other}", vars("var10", "replaced", "v2", "s"),
                "some s text s");
    ...
    public void regexSplit() {
        ...
        assertRegexSet("a,b\\,", "a", "b,");
        assertRegexSet("a\\\\\\,b", "a\\\\,b");
        assertRegexSet("DROP TEMPORARY TABLE IF EXISTS .+ /\\\\* generated by server \\\\*/,"
    ...
    protected void assertRegexSet(String patterns, String... matches) {
        ...
        assertThat(regexSet.stream().map(Pattern::pattern).collect(Collectors.toSet()))
                .containsOnly((Object[]) matches);
    }
    ...
    protected void assertRegexList(String patterns, String... matches) {
        ...
        assertThat(regexList.stream().map(Pattern::pattern).collect(Collectors.toList()))
                .isEqualTo(Arrays.asList((Object[]) matches));
    }
}
