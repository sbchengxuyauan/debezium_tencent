...
public interface Testing {
    ...
    public static interface Network {
        /**
         * Find a port that is available. This method starts a {@link ServerSocket} and obtains the port on which the
         * socket is listening, and then shuts down the socket so the port becomes available.
         *
    ...
    public static interface Files {
         ...
         *            the path of the resource on the classpath
         * @param testClass
         *            the test class, used for accessing the class loader
         * 
         ...
         *
         * @param relativePath
         *            the path of the directory within the test data directory; may not be null
         * 
         ...
         *
         * @param relativePath
         *            the path of the file within the test data directory; may not be null
         * 
         * @return the reference to the existing readable and writable file
         */
         ...
         */
        public static File createTestingDirectory(String relativePath, boolean removeExistingContent)
                throws IOException {
            Path dirPath = createTestingPath(relativePath);
        ...
        /**
         * A method that will delete a file or folder only if it is within the 'target' directory (for safety). Folders
         ...
         *
         * @param fileOrFolder
         *            the file or folder in the target directory
         */
         ...
         *
         * @param path
         *            the path to the file or directory; may not be null
         * 
         * @return true if inside the test data directory, or false otherwise
         */
    ...
    default public Statistics time(String desc, int repeat, InterruptableFunction runnable)
            throws InterruptedException {
        return Timer.time(desc, repeat, runnable, null);
    }

    default public <T> Statistics time(String desc, int repeat, Callable<T> runnable, Consumer<T> cleanup)
            throws InterruptedException {
    ...
    public static final class Timer {
        ...
        protected static <T> Statistics time(String desc, int repeat, Callable<T> runnable, Consumer<T> cleanup)
            ...
            sw.stop();
            // if (desc != null) Testing.print(60, "Time to " + desc + ":",
