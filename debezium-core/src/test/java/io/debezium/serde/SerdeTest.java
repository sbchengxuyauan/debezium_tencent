...
public class SerdeTest implements Testing {
    ...
    public void simpleKey() {
        ...
        Assertions.assertThat(keySerde.deserializer().deserialize("xx", "{\"payload\": {\"a\": 1}}".getBytes()))
                .isEqualTo(1);
        Assertions.assertThat(keySerde.deserializer().deserialize("xx", "{\"payload\": 1}".getBytes())).isEqualTo(1);
        Assertions.assertThat(keySerde.deserializer().deserialize("xx", "{\"payload\": {\"a\": null}}".getBytes()))
                .isNull();
    ...
    public void compositeKey() {
        ...
        keySerde.configure(Collections.emptyMap(), true);
        Assertions.assertThat(keySerde.deserializer().deserialize("xx", "{\"a\": 1, \"b\": 2}".getBytes()))
                .isEqualTo(new CompositeKey(1, 2));
    }
    ...
    public void valuePayloadWithSchema() {
        ...
        Assertions.assertThat(valueSerde.deserializer().deserialize("xx", content.getBytes()))
                .isEqualTo(new Customer(1004, "Anne", "Kretchmar", "annek@noanswer.org"));
    }
