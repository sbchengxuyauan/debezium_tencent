...
public class KafkaClusterTest {
    ...
    public void beforeEach() {
        ...
        cluster = new KafkaCluster().usingDirectory(dataDir).deleteDataPriorToStartup(true).deleteDataUponShutdown(true)
    ...
    public void shouldStartClusterAndAllowProducersAndConsumersToUseIt() throws Exception {
        ...
        cluster.useTo().consumeIntegers(topicName, numMessages, 10, TimeUnit.SECONDS, completion::countDown,
                (key, value) -> {
    ...
    public void shouldStartClusterAndAllowInteractiveProductionAndAutomaticConsumersToUseIt() throws Exception {
        ...
        cluster.useTo().createProducer("manual", new StringSerializer(), new IntegerSerializer())
                .write(topicName, "key1", 1).write(topicName, "key2", 2).write(topicName, "key3", 3).close();
    ...
    public void shouldSetServerConfigProperty() throws Exception {
        ...
        ConcurrentMap<Integer, KafkaServer> kafkaServers = (ConcurrentMap<Integer, KafkaServer>) kafkaServersField
                .get(kafkaCluster);
