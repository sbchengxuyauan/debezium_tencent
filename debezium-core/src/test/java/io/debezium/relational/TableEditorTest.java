...
public class TableEditorTest {
    ...
    public void shouldFindAutoIncrementedColumns() {
        editor.tableId(id);
        Column c1 = columnEditor.name("C1").type("VARCHAR").jdbcType(Types.VARCHAR).length(10).position(1).create();
        Column c2 = columnEditor.name("C2").type("NUMBER").jdbcType(Types.NUMERIC).length(5).autoIncremented(true)
                .create();
    ...
    public void shouldReorderColumns() {
        ...
        assertThat(editor.columns()).containsExactly(editor.columnWithName("C1"), editor.columnWithName("C2"),
        ...
        assertThat(editor.columns()).containsExactly(editor.columnWithName("C3"), editor.columnWithName("C1"),
                editor.columnWithName("C2"));
        assertValidPositions(editor);
    }
