...
/**
 * A test utility for accumulating the {@link SourceRecord}s that represent change events on rows. This store applies
 * the changes and maintains the current state of the rows.
 *
...
public class KeyValueStore {
    ...
    /**
     * Create a KeyValueStore that uses the supplied regular expression and group number to extract the {@link TableId}
     * from the topic name.
     *
     * @param regex
     *            the regular expression that identifies the table ID within the topic name; may not be null
     * @param groupNumber
     *            the group number in the regex for the table ID string
     * 
     ...
     *
     * @param prefix
     *            the prefix after which all of the topic name forms the table ID; may not be null
     * 
     * @return the key value store
     */
    ...
    public static class Collection {
        ...
        /**
         * Get the number of {@link Operation#CREATE CREATE} records {@link #add(SourceRecord) added} to this
         * collection.
         *
         * @return the count; never negative
         */
        ...
        /**
         * Get the number of {@link Operation#DELETE DELETE} records {@link #add(SourceRecord) added} to this
         * collection.
         *
         * @return the count; never negative
         */
        ...
        /**
         * Get the number of {@link Operation#UPDATE UPDATE} records {@link #add(SourceRecord) added} to this
         * collection.
         *
         * @return the count; never negative
         */
