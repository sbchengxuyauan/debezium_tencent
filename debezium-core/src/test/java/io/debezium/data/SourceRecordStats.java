...
public class SourceRecordStats implements Consumer<SourceRecord> {
     ...
     *
     * @param op
     *            the operation for which the record count is to be returned
     * 
    ...
    /**
     * Get the number of {@link Operation#CREATE CREATE} records that were {@link #accept(SourceRecord) added} to this
     * object.
     *
     * @return the count; never negative
     */
    ...
    /**
     * Get the number of {@link Operation#DELETE DELETE} records that were {@link #accept(SourceRecord) added} to this
     * object.
     *
     * @return the count; never negative
     */
    ...
    /**
     * Get the number of {@link Operation#READ READ} records that were {@link #accept(SourceRecord) added} to this
     * object.
     *
     * @return the count; never negative
     */
    ...
    /**
     * Get the number of {@link Operation#UPDATE UPDATE} records that were {@link #accept(SourceRecord) added} to this
     * object.
     *
     * @return the count; never negative
     */
    ...
    public String toString() {
        return "" + numberOfCreates() + " creates, " + numberOfUpdates() + " updates, " + numberOfDeletes()
                + " deletes, " + numberOfReads() + " reads";
    }
