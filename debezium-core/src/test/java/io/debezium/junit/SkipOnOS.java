...
/**
 * Marker annotation used together with the {@link SkipTestRule} JUnit rule, that allows tests to be excluded from the
 * build if they are run on certain platforms.
 *
