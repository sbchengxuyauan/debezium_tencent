...
/**
 * JUnit rule that inspects the presence of the {@link SkipLongRunning} annotation either on a test method or on a test
 * suite. If it finds the annotation, it will only run the test method/suite if the system property
 * {@code skipLongRunningTests} has the value {@code true}
 *
