...
/**
 * JUnit rule that inspects the presence of the {@link ShouldFailWhen} annotation on a test method. If it finds the
 * annotation, it will modify pass/fail report of test depending on the condition defined in the annotation.
 *
