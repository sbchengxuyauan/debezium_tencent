...
/**
 * Marker annotation used together with the {@link SkipTestRule} JUnit rule, that allows long running tests to be
 * excluded from the build, using the {@code skipLongRunningTests} system property.
 *
