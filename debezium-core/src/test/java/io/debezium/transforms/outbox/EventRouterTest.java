...
public class EventRouterTest {
    ...
    public void canSkipTombstone() {
        ...
        final SourceRecord eventRecord = new SourceRecord(new HashMap<>(), new HashMap<>(), "db.outbox",
                SchemaBuilder.STRING_SCHEMA, "123123", null, null);
    ...
    public void canSkipDeletion() {
        ...
        final SourceRecord eventRecord = new SourceRecord(new HashMap<>(), new HashMap<>(), "db.outbox",
                SchemaBuilder.STRING_SCHEMA, "772590bf-ef2d-4814-b4bf-ddc6f5f8b9c5", envelope.schema(), payload);
    ...
    public void canSkipMessagesWithoutDebeziumCdcEnvelopeDueToMissingSchemaName() {
        ...
        Schema valueSchema = SchemaBuilder.struct().field(AbstractSourceInfo.TIMESTAMP_KEY, Schema.INT64_SCHEMA)
                .build();
        ...
        final SourceRecord eventRecord = new SourceRecord(new HashMap<>(), new HashMap<>(), "db.outbox",
                SchemaBuilder.STRING_SCHEMA, "772590bf-ef2d-4814-b4bf-ddc6f5f8b9c5", valueSchema, value);
    ...
    public void shouldFailWhenTheSchemaLooksValidButDoesNotHaveTheCorrectFields() {
        ...
        Schema valueSchema = SchemaBuilder.struct().name("io.debezium.connector.common.Heartbeat.Envelope")
                .field(AbstractSourceInfo.TIMESTAMP_KEY, Schema.INT64_SCHEMA).build();
    ...
    public void canSkipMessagesWithoutDebeziumCdcEnvelopeDueToMissingSchemaNameSuffix() {
        ...
        Schema valueSchema = SchemaBuilder.struct().name("io.debezium.connector.common.Heartbeat")
                .field(AbstractSourceInfo.TIMESTAMP_KEY, Schema.INT64_SCHEMA).build();
    ...
    public void canSkipMessagesWithoutDebeziumCdcEnvelopeDueToMissingValueSchema() {
        ...
        final SourceRecord eventRecord = new SourceRecord(new HashMap<>(), new HashMap<>(), "db.outbox",
                SchemaBuilder.STRING_SCHEMA, "772590bf-ef2d-4814-b4bf-ddc6f5f8b9c5", null, value);
    ...
    public void canFailOnUpdates() {
        final EventRouter<SourceRecord> router = new EventRouter<>();
        final Map<String, String> config = new HashMap<>();
        config.put(EventRouterConfigDefinition.OPERATION_INVALID_BEHAVIOR.name(),
    ...
    public void canSetTimestampByUserDefinedConfiguration() {
        ...
        final SourceRecord userEventRecord = createEventRecord("166080d9-3b0e-4a04-81fe-2058a7386f1f", "UserCreated",
                "420b186d", "User", "{}", extraFields, extraValues);
        final SourceRecord userEventRouted = router.apply(userEventRecord);
    ...
    public void canRouteBasedOnField() {
        ...
        final SourceRecord userUpdatedEventRecord = createEventRecord("ab720dd3-176d-40a6-96f3-6cf961d7df6a",
                "UserUpdate", "10711fa5", "User", "{}");
        ...
        final SourceRecord addressCreatedEventRecord = createEventRecord("ab720dd3-176d-40a6-96f3-6cf961d7df6a",
                "AddressCreated", "10711fa5", "Address", "{}");
    ...
    public void canConfigureEveryTableField() {
        ...
        final Schema recordSchema = SchemaBuilder.struct().field("event_id", SchemaBuilder.string())
                .field("payload_id", SchemaBuilder.string()).field("event_type", SchemaBuilder.string())
                .field("payload_body", SchemaBuilder.string()).build();

        Envelope envelope = Envelope.defineSchema().withName("event.Envelope").withRecord(recordSchema)
                .withSource(SchemaBuilder.struct().build()).build();
    ...
    public void canInfluenceTableColumnTypes() {
        ...
        final Schema recordSchema = SchemaBuilder.struct().field("event_id", SchemaBuilder.int32())
                .field("payload_id", SchemaBuilder.int32()).field("my_route_field", SchemaBuilder.string())
                .field("event_type", SchemaBuilder.bytes()).field("payload_body", SchemaBuilder.bytes())
                .field("some_boolean", SchemaBuilder.bool()).build();
    ...
    public void canSetSchemaVersion() {
        ...
        final SourceRecord eventRecordV1 = createEventRecord("166080d9-3b0e-4a04-81fe-2058a7386f1f", "UserCreated",
                "420b186d", "User", "{}", extraFields, extraValuesV1);
        ...
        final SourceRecord eventRecordV3 = createEventRecord("166080d9-3b0e-4a04-81fe-2058a7386f1f", "UserCreated",
                "420b186d", "User", "{}", extraFields, extraValuesV3);
        ...
        final SourceRecord eventRecordV1E2 = createEventRecord("18f94a39-b931-41b7-837c-6fc23b013597", "UserCreated",
                "1b10b70b", "User", "{}", extraFields, extraValuesV1);
    ...
    public void canMarkAnEventAsDeleted() {
        ...
        final SourceRecord eventRecord = createEventRecord("da8d6de6-3b77-45ff-8f44-57db55a7a06c", "UserCreated",
                "10711fa5", "User", "{}", extraFields, extraValues);
        final SourceRecord eventRouted = router.apply(eventRecord);
        ...
        final SourceRecord eventRecordTombstone = createEventRecord("da8d6de6-3b77-45ff-8f44-57db55a7a06c",
                "UserCreated", "10711fa5", "User", "", extraFields, extraValues);
    ...
    private SourceRecord createEventRecord(String eventId, String eventType, String payloadId, String payloadType,
            String payload) {
        return createEventRecord(eventId, eventType, payloadId, payloadType, payload, new HashMap<>(), new HashMap<>());
    }

    private SourceRecord createEventRecord(String eventId, String eventType, String payloadId, String payloadType,
            String payload, Map<String, Schema> extraFields, Map<String, Object> extraValues) {
        SchemaBuilder schemaBuilder = SchemaBuilder.struct().field("id", SchemaBuilder.string())
                .field("aggregatetype", SchemaBuilder.string()).field("aggregateid", SchemaBuilder.string())
                .field("type", SchemaBuilder.string()).field("payload", SchemaBuilder.string())
