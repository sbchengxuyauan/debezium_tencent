...
public interface CustomConverter<S, F extends ConvertedField> {
    ...
    public interface ConverterRegistration<S> {
        ...
        /**
         * Registers the given schema and converter for the current field. Should not be invoked more than once for the
         * same field.
         */
     ...
     * @param registration
     *            a callback that allows to register a schema and value converter for the given field.
     */
