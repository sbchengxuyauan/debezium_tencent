...
public class ProxyParseTreeListenerUtil {
     ...
     *
     * @param ctx
     *            enter rule context; may not be null
     * @param listeners
     *            collection of listeners; may not be null
     * @param errors
     *            collection of errors; may not be null
     */
    public static void delegateEnterRule(ParserRuleContext ctx, Collection<ParseTreeListener> listeners,
     ...
     *
     * @param ctx
     *            exit rule context; may not be null
     * @param listeners
     *            collection of listeners; may not be null
     * @param errors
     *            collection of errors; may not be null
     */
    public static void delegateExitRule(ParserRuleContext ctx, Collection<ParseTreeListener> listeners,
            Collection<ParsingException> errors) {
        for (ParseTreeListener listener : listeners) {
            try {
    ...
    /**
     * Delegates visit error node event to collection of parsing listeners and captures parsing exceptions that may
     * appear.
     *
     * @param node
     *            error node; may not be null
     * @param listeners
     *            collection of listeners; may not be null
     * @param errors
     *            collection of errors; may not be null
     */
    public static void visitErrorNode(ErrorNode node, Collection<ParseTreeListener> listeners,
            Collection<ParsingException> errors) {
        for (ParseTreeListener listener : listeners) {
            try {
    ...
    /**
     * Delegates visit terminal event to collection of parsing listeners and captures parsing exceptions that may
     * appear.
     *
     * @param node
     *            terminal node; may not be null
     * @param listeners
     *            collection of listeners; may not be null
     * @param errors
     *            collection of errors; may not be null
     */
    public static void visitTerminal(TerminalNode node, Collection<ParseTreeListener> listeners,
            Collection<ParsingException> errors) {
        for (ParseTreeListener listener : listeners) {
            try {
