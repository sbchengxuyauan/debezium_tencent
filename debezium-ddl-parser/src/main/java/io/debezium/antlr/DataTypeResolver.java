 ...
 *
 * Its main purpose is to match corresponding JDBC data type, resolve a name of parsed data type, and optionally
 * predefine default values for length and scale for DBMS data type.
 *
...
public class DataTypeResolver {
     ...
     *
     * @param dataTypeContext
     *            parse context; may not e null
     * @return instance of {@link DataType}, which will holds matched JDBC type, name and default values for length and
     *         scale.
     */
    ...
    private DataType buildDataType(ParserRuleContext dataTypeContext, DataTypeEntry dataTypeEntry,
    ...
    private void addOptionalSuffixToName(ParserRuleContext dataTypeContext, DataTypeEntry dataTypeEntry,
            DataTypeBuilder dataTypeBuilder) {
    ...
    public static class Builder {
         ...
         *
         * @param contextClassCanonicalName
         *            canonical name of context instance, in which the data type entry will appear; may not be null
         * @param dataTypeEntries
         *            list of {@link DataTypeEntry} definitions; may not be null
         */
