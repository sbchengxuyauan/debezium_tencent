 ...
 * <p>
 * This abstract class provides generic initialization of parser and its main sequence of steps that are needed to
 * properly start parsing. It also provides implementation of helper methods for any type of ANTLR listeners.
 *
...
public abstract class AntlrDdlParser<L extends Lexer, P extends Parser> extends AbstractDdlParser {
    ...
    /**
     * Flag to indicate if the errors caught during tree walk will be thrown. true = errors will be thrown false =
     * errors will not be thrown. They will be available to get by
     * {@link AntlrDdlParser#getParsingExceptionsFromWalker()}.
     */
    ...
    public void parse(String ddlContent, Tables databaseTables) {
        ...
        ParsingErrorListener parsingErrorListener = new ParsingErrorListener(
                AbstractDdlParser::accumulateParsingFailure);
     ...
     *
     * @param parser
     *            initialized ANTLR parser instance with common token stream from DDL statement; may not be null
     */
     ...
     *
     * @param charStreams
     *            the char stream from DDL statement, without one line comments and line feeds; may not be null
     ...
     *            the stream of ANTLR tokens created from Lexer instance; may not be null
     ...
     *
     * @param ctx
     *            the parser rule context; may not be null
