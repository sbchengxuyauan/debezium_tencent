...
public interface AvailableVariables {
    ...
    /**
     * Get an {@link AvailableVariables} that returns the value of a {@link Configuration#getString(String)
     * Configuration property}.
     *
     * @param config
     *            the configuration
     * @return the available variables function that returns the configuration property value for the given property
     *         name; never null
     */
    ...
    /**
     * Get an {@link AvailableVariables} that returns {@link System#getenv(String) System environment variables} set
     * with operating system environment variables (e.g., <code>${JAVA_HOME}</code>).
     * <p>
     * This method does not use the configuration.
     *
     * @param config
     ...
     *
     * @param varName
     *            the variable name; may be null
     * @return the value of the variable; may be null if the named variable is not known
     */
    String variableForName(String varName);

    /**
     * Obtain an {@link AvailableVariables} function that first checks this instance and then checks the supplied
     * instance.
     *
     * @param next
     *            the next {@link AvailableVariables} instance to check
     * @return the new {@link AvailableVariables} function that combines both instances; never null but may be this
     *         instance if {@code next} is null or {@this}
     */
