 ...
 * {@link io.debezium.connector.postgresql.PostgresConnectorConfig.SNAPSHOT_SELECT_STATEMENT_OVERRIDES_BY_TABLE}
 *
 * @author Jiri Pechanec (jpechane@redhat.com)
 */
public class SnapshotWithOverridesProducerIT extends AbstractRecordsProducerTest {

    private static final String STATEMENTS = "CREATE SCHEMA over;" + "CREATE TABLE over.t1 (pk INT, PRIMARY KEY(pk));"
            + "CREATE TABLE over.t2 (pk INT, PRIMARY KEY(pk));" + "INSERT INTO over.t1 VALUES (1);"
            + "INSERT INTO over.t1 VALUES (2);" + "INSERT INTO over.t1 VALUES (3);"
            + "INSERT INTO over.t1 VALUES (101);" + "INSERT INTO over.t1 VALUES (102);"
            + "INSERT INTO over.t1 VALUES (103);" + "INSERT INTO over.t2 VALUES (1);"
            + "INSERT INTO over.t2 VALUES (2);" + "INSERT INTO over.t2 VALUES (3);"
            + "INSERT INTO over.t2 VALUES (101);" + "INSERT INTO over.t2 VALUES (102);"
    ...
    public void shouldUseOverriddenSelectStatementDuringSnapshotting() throws Exception {
        ...
        buildProducer(TestHelper.defaultConfig()
                ...
                .with(PostgresConnectorConfig.SNAPSHOT_SELECT_STATEMENT_OVERRIDES_BY_TABLE.name() + ".over.t1",
                        "SELECT * FROM over.t1 WHERE pk > 100"));
    ...
    public void shouldUseMultipleOverriddenSelectStatementsDuringSnapshotting() throws Exception {
        ...
        buildProducer(TestHelper.defaultConfig()
                ...
                .with(PostgresConnectorConfig.SNAPSHOT_SELECT_STATEMENT_OVERRIDES_BY_TABLE.name() + ".over.t1",
                        "SELECT * FROM over.t1 WHERE pk > 101")
                .with(PostgresConnectorConfig.SNAPSHOT_SELECT_STATEMENT_OVERRIDES_BY_TABLE.name() + ".over.t2",
                        "SELECT * FROM over.t2 WHERE pk > 100"));
    ...
    private void buildProducer(Configuration.Builder config) {
        start(PostgresConnector.class,
                config.with(PostgresConnectorConfig.SNAPSHOT_MODE, SnapshotMode.INITIAL_ONLY).build());
