...
/**
 * Marker annotation used together with the {@link SkipTestDependingOnDatabaseVersionRule} JUnit rule, that allows tests
 * to be skipped based on the Postgres version used for testing.
 *
