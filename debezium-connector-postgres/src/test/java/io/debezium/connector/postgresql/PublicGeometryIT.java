...
public class PublicGeometryIT extends AbstractRecordsProducerTest {
    ...
    public void before() throws Exception {
        ...
        TestHelper.execute("DROP SCHEMA IF EXISTS postgis CASCADE;",
    ...
    private void setupRecordsProducer(Configuration.Builder config) {
        start(PostgresConnector.class, config.with(PostgresConnectorConfig.SNAPSHOT_MODE, SnapshotMode.NEVER).build());
