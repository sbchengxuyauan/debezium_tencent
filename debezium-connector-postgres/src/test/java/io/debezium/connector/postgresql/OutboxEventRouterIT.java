...
public class OutboxEventRouterIT extends AbstractConnectorTest {
    ...
    private static final String SETUP_OUTOBOX_TABLE = "CREATE TABLE outboxsmtit.outbox " + "("
            ...
            + "  aggregatetype varchar(255) not null," + "  aggregateid   varchar(255) not null,"
            + "  type          varchar(255) not null," + "  payload       jsonb" + ");";

    private EventRouter<SourceRecord> outboxEventRouter;

    private static String createEventInsert(UUID eventId, String eventType, String aggregateType, String aggregateId,
            String payloadJson, String additional) {
    ...
    public void shouldConsumeRecordsFromInsert() throws Exception {
        ...
        TestHelper.execute(createEventInsert(UUID.fromString("59a42efd-b015-44a9-9dde-cb36d9002425"), "UserCreated",
                "User", "10711fa5", "{}", ""));
    ...
    public void shouldSendEventTypeAsHeader() throws Exception {
        ...
        TestHelper.execute(createEventInsert(UUID.fromString("59a42efd-b015-44a9-9dde-cb36d9002425"), "UserCreated",
                "User", "10711fa5", "{\"email\": \"gh@mefi.in\"}", ""));
    ...
    public void shouldRespectJsonFormatAsString() throws Exception {
        ...
        TestHelper.execute(createEventInsert(UUID.fromString("f9171eb6-19f3-4579-9206-0e179d2ebad7"), "UserCreated",
                "User", "7bdf2e9e", "{\"email\": \"gh@mefi.in\"}", ""));
    ...
    public void shouldSupportAllFeatures() throws Exception {
        ...
        config.put("table.fields.additional.placement",
                "version:envelope:eventVersion," + "aggregatetype:envelope:aggregateType,"
                        + "somebooltype:envelope:someBoolType," + "somebooltype:header,"
        ...
        TestHelper.execute(
                createEventInsert(UUID.fromString("f9171eb6-19f3-4579-9206-0e179d2ebad7"), "UserUpdated", "UserEmail",
                        "7bdf2e9e", "{\"email\": \"gh@mefi.in\"}", ", 1, true, TIMESTAMP(3) '2019-03-24 20:52:59'"));
        ...
        // Validate metadata
        Schema expectedSchema = SchemaBuilder.struct().version(1).field("payload", Json.builder().optional().build())
                .field("eventType", Schema.STRING_SCHEMA).field("eventVersion", Schema.INT32_SCHEMA)
                .field("aggregateType", Schema.STRING_SCHEMA).field("someBoolType", Schema.BOOLEAN_SCHEMA)
                .field("deleted", Schema.OPTIONAL_BOOLEAN_SCHEMA).build();
    ...
    public void shouldConvertMicroSecondsTimestampToMilliSeconds() throws Exception {
        ...
        TestHelper.execute(createEventInsert(UUID.fromString("f9171eb6-19f3-4579-9206-0e179d2ebad7"), "UserUpdated",
                "UserEmail", "7bdf2e9e", "{\"email\": \"gh@mefi.in\"}", ", TIMESTAMP '2019-03-24 20:52:59'"));
    ...
    public void shouldNotProduceTombstoneEventForNullPayload() throws Exception {
        ...
        TestHelper.execute(createEventInsert(UUID.fromString("a9d76f78-bda6-48d3-97ed-13a146163218"), "UserUpdated",
                "UserEmail", "a9d76f78", null, ", 1, true, TIMESTAMP '2019-03-24 20:52:59', true"));
    ...
    private void startConnectorWithInitialSnapshotRecord() throws Exception {
        TestHelper.execute(createEventInsert(UUID.fromString("70f52ae3-f671-4bac-ae62-1b9be6e73700"), "UserCreated",
                "User", "10711faf", "{}", ""));
    ...
    private static Configuration.Builder getConfigurationBuilder(SnapshotMode snapshotMode) {
        return TestHelper.defaultConfig().with(PostgresConnectorConfig.SNAPSHOT_MODE, snapshotMode.getValue())
