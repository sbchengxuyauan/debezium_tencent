...
public class PostgresMetricsIT extends AbstractRecordsProducerTest {
    ...
    public void testLifecycle() throws Exception {
        ...
        start(PostgresConnector.class,
                TestHelper.defaultConfig().with(PostgresConnectorConfig.SNAPSHOT_MODE, SnapshotMode.ALWAYS)
    ...
    public void testSnapshotOnlyMetrics() throws Exception {
        ...
        // start connector
        start(PostgresConnector.class,
                TestHelper.defaultConfig().with(PostgresConnectorConfig.SNAPSHOT_MODE, SnapshotMode.INITIAL_ONLY)
                        .with(PostgresConnectorConfig.DROP_SLOT_ON_STOP, Boolean.TRUE).build());
    ...
    public void testStreamingOnlyMetrics() throws Exception {
        ...
        // start connector
        start(PostgresConnector.class,
                TestHelper.defaultConfig().with(PostgresConnectorConfig.SNAPSHOT_MODE, SnapshotMode.NEVER)
                        .with(PostgresConnectorConfig.DROP_SLOT_ON_STOP, Boolean.TRUE).build());
    ...
    private void assertSnapshotMetrics() throws Exception {
        ...
        Assertions.assertThat(mBeanServer.getAttribute(getSnapshotMetricsObjectName(), "MonitoredTables"))
                .isEqualTo(new String[] { "public.simple" });
        Assertions.assertThat(mBeanServer.getAttribute(getSnapshotMetricsObjectName(), "TotalNumberOfEventsSeen"))
                .isEqualTo(2L);
        Assertions.assertThat(mBeanServer.getAttribute(getSnapshotMetricsObjectName(), "RemainingTableCount"))
                .isEqualTo(0);
        Assertions.assertThat(mBeanServer.getAttribute(getSnapshotMetricsObjectName(), "SnapshotRunning"))
                .isEqualTo(false);
        Assertions.assertThat(mBeanServer.getAttribute(getSnapshotMetricsObjectName(), "SnapshotAborted"))
                .isEqualTo(false);
        Assertions.assertThat(mBeanServer.getAttribute(getSnapshotMetricsObjectName(), "SnapshotCompleted"))
                .isEqualTo(true);
    }
    ...
    private void assertSnapshotNotExecutedMetrics() throws Exception {
        ...
        Awaitility.await("Waiting for snapshot metrics to appear")
    ...
    private void assertStreamingMetrics() throws Exception {
        ...
        Assertions.assertThat(mBeanServer.getAttribute(getStreamingMetricsObjectName(), "TotalNumberOfEventsSeen"))
                .isEqualTo(2L);
        // todo: this does not seem to be populated?
        // Assertions.assertThat(mBeanServer.getAttribute(getStreamingMetricsObjectName(),
        // "MonitoredTables")).isEqualTo(new String[] {"public.simple"});
    }
