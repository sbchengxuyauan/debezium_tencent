...
public class PgOutputRelationMetaData {
     ...
     *
     * @param relationId
     *            the postgres relation identifier, unique provided by the pgoutput stream
     * @param schema
     *            the schema the table exists within; should never be null
     * @param name
     *            the name of the table; should never be null
     * @param columns
     *            list of column metadata instances describing the state of each column
     */
