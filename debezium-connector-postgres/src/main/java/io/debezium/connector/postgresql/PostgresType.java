...
/**
 * A class that binds together a PostgresSQL OID, JDBC type id and the string name of the type. The array types contain
 * link to their element type.
 *
...
public class PostgresType {
    ...
    private PostgresType(String name, int oid, int jdbcId, TypeInfo typeInfo, List<String> enumValues,
            PostgresType parentType, PostgresType elementType) {
        this(name, oid, jdbcId, TypeRegistry.NO_TYPE_MODIFIER, typeInfo, enumValues, parentType, elementType);
    }

    private PostgresType(String name, int oid, int jdbcId, int modifiers, TypeInfo typeInfo, List<String> enumValues,
            PostgresType parentType, PostgresType elementType) {
     ...
     * When a type does not extend another type, it is considered to be a base or root type in the type hierarchy.
     *
    ...
    /**
     * @param modifier
     *            - type modifier coming from decoder
     * 
    ...
    public String toString() {
        return "PostgresType [name=" + name + ", oid=" + oid + ", jdbcId=" + jdbcId + ", modifiers=" + modifiers
                + ", defaultLength=" + getDefaultLength() + ", defaultScale=" + getDefaultScale() + ", parentType="
