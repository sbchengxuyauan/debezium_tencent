...
public class PostgresOffsetContext implements OffsetContext {
    ...
    private PostgresOffsetContext(PostgresConnectorConfig connectorConfig, Long lsn, Long lastCompletelyProcessedLsn,
            Long txId, Instant time, boolean snapshot, boolean lastSnapshotRecord,
    ...
    public void updateWalPosition(Long lsn, Long lastCompletelyProcessedLsn, Instant commitTime, Long txId,
            TableId tableId, Long xmin) {
        this.lastCompletelyProcessedLsn = lastCompletelyProcessedLsn;
    ...
    public static class Loader implements OffsetContext.Loader {
        ...
        public OffsetContext load(Map<String, ?> offset) {
            ...
            final boolean snapshot = (boolean) ((Map<String, Object>) offset).getOrDefault(SourceInfo.SNAPSHOT_KEY,
                    Boolean.FALSE);
            ...
            return new PostgresOffsetContext(connectorConfig, lsn, lastCompletelyProcessedLsn, txId, useconds, snapshot,
                    lastSnapshotRecord, TransactionContext.load(offset));
        }
    }

    @Override
    public String toString() {
        return "PostgresOffsetContext [sourceInfo=" + sourceInfo + ", partition=" + partition + ", lastSnapshotRecord="
                + lastSnapshotRecord + "]";
    }

    public static PostgresOffsetContext initialContext(PostgresConnectorConfig connectorConfig,
        ...
        try {
            ...
            return new PostgresOffsetContext(connectorConfig, lsn, null, txId, clock.currentTimeAsInstant(), false,
                    false, new TransactionContext());
    ...
    public OffsetState asOffsetState() {
        return new OffsetState(sourceInfo.lsn(), sourceInfo.txId(), sourceInfo.xmin(), sourceInfo.timestamp(),
