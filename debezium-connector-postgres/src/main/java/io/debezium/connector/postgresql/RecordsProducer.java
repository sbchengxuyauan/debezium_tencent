...
public abstract class RecordsProducer {
    ...
    /**
     * Starts up this producer. This is normally done by a {@link PostgresConnectorTask} instance. Subclasses should
     * start enqueuing records via a separate thread at the end of this method.
     *
     * @param recordsConsumer
     *            a consumer of {@link ChangeEvent} instances, may not be null
     */
    ...
    /**
     * Requests that this producer be stopped. This is normally a request coming from a {@link PostgresConnectorTask}
     * instance
     */
