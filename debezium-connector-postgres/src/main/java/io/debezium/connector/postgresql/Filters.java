...
public class Filters {
    ...
    public Filters(PostgresConnectorConfig config) {
        ...
        this.tableFilter = TableFilter.fromPredicate(
                Selectors.tableSelector().includeTables(config.tableWhitelist()).excludeTables(tableBlacklist)
                        .includeSchemas(config.schemaWhitelist()).excludeSchemas(schemaBlacklist).build());
