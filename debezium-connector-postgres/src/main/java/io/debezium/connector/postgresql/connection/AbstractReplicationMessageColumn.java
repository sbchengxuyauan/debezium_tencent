...
/**
 * Extracts type information from replication messages and associates them with each column. The metadata are parsed
 * lazily.
 *
...
public abstract class AbstractReplicationMessageColumn implements ReplicationMessage.Column {
    ...
    public static class TypeMetadataImpl implements ReplicationMessage.ColumnTypeMetadata {
        ...
        // "text"; "character varying(255)"; "numeric(12,3)"; "geometry(MultiPolygon,4326)"; "timestamp (12) with time
        // zone"; "int[]"; "myschema.geometry"
    ...
    public AbstractReplicationMessageColumn(String columnName, PostgresType type, String typeWithModifiers,
            boolean optional, boolean hasMetadata) {
        super();
