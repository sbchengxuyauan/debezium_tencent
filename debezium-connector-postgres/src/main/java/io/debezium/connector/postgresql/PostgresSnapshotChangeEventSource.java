...
public class PostgresSnapshotChangeEventSource extends RelationalSnapshotChangeEventSource {
    ...
    public PostgresSnapshotChangeEventSource(PostgresConnectorConfig connectorConfig, Snapshotter snapshotter,
            PostgresOffsetContext previousOffset, PostgresConnection jdbcConnection, PostgresSchema schema,
    ...
    protected void lockTablesForSchemaSnapshot(ChangeEventSourceContext sourceContext,
        ...
        final Optional<String> lockStatement = snapshotter.snapshotTableLockingStatement(lockTimeout,
                schema.tableIds());
        LOGGER.info("执行的锁表sql: " + lockStatement.get());

        if (lockStatement.isPresent()) { // sql 不为null
