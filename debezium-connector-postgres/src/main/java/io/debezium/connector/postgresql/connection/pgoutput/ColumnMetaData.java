...
public class ColumnMetaData {
     ...
     *
     * @param columnName
     *            name of the column; must not be null
     * @param postgresType
     *            postgres database type; must not be null
     * @param key
     *            {@code true} if column is part of the primary key, {@code false} otherwise
     * @param optional
     *            {@code true} if the column is considered optional, {@code false} otherwise
     * @param typeModifier
