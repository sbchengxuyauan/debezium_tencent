...
public class PostgisGeometry {
    ...
    /**
     * PostGIS Extended-Well-Known-Binary (EWKB) geometry representation. An extension of the Open Geospatial Consortium
     * Well-Known-Binary format. Since EWKB is a superset of WKB, we use EWKB here.
     * https://postgis.net/docs/using_postgis_dbmanagement.html#EWKB_EWKT http://www.opengeospatial.org/standards/sfa
     */
    private final byte[] wkb;

    /**
     * Coordinate reference system identifier. While it's technically user-defined, the standard/common values in use
     * are the EPSG code list http://www.epsg.org/ null if unset/unspecified
     */
     ...
     *
     * @param ewkb
     *            the Extended Well-Known binary representation of the coordinate in the standard format
     * @param srid
     *            the coordinate system identifier (SRID); null if unset/unknown
     */
