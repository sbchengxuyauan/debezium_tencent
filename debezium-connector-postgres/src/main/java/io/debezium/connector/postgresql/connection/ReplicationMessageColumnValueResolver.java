...
public class ReplicationMessageColumnValueResolver {
     ...
     *            the postgres type
     * @param fullType
     *            the full type-name for the column
     * @param value
     *            the column value
     * @param connection
     *            a postgres connection supplier
     * @param includeUnknownDatatypes
     *            true to include unknown data types, false otherwise
     * @param typeRegistry
     *            the postgres type registry
     * 
     * @return
     */
    public static Object resolveValue(String columnName, PostgresType type, String fullType, ColumnValue value,
        ...
        if (!type.isRootType()) {
            return resolveValue(columnName, type.getParentType(), fullType, value, connection, includeUnknownDatatypes,
                    typeRegistry);
        }
