...
public class LegacyV1PostgresSourceInfoStructMaker extends LegacyV1AbstractSourceInfoStructMaker<SourceInfo> {
    ...
    public LegacyV1PostgresSourceInfoStructMaker(String connector, String version,
            CommonConnectorConfig connectorConfig) {
        super(connector, version, connectorConfig);
        schema = commonSchemaBuilder().name("io.debezium.connector.postgresql.Source")
                ...
                .field(SourceInfo.XMIN_KEY, Schema.OPTIONAL_INT64_SCHEMA).build();
