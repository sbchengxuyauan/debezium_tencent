...
/**
 * A Kafka Connect source connector that creates tasks which use Postgresql streaming replication off a logical
 * replication slot to receive incoming changes for a database and publish them to Kafka.
 * <h2>Configuration</h2>
 * <p>
...
public class PostgresConnector extends SourceConnector {
    ...
    public void start(Map<String, String> props) {
        logger.info("postgresql connector is starting");
    ...
    public Config validate(Map<String, String> connectorConfigs) {
        ...
        if (hostnameValue.errorMessages().isEmpty() && portValue.errorMessages().isEmpty()
                && userValue.errorMessages().isEmpty() && passwordValue.errorMessages().isEmpty()
