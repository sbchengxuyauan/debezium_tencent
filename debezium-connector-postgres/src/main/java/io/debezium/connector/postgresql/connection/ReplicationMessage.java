...
/**
 * An abstract representation of a replication message that is sent by a PostgreSQL logical decoding plugin and is
 * processed by the Debezium PostgreSQL connector.
 *
...
public interface ReplicationMessage {
    ...
    public enum Operation {
        INSERT, UPDATE, DELETE, BEGIN, COMMIT, NOOP
    }
    ...
    public interface ColumnValue<T> {
        ...
        Object asDefault(TypeRegistry typeRegistry, int columnType, String columnName, String fullType,
                boolean includeUnknownDatatypes, PgConnectionSupplier connection);
    }
    ...
    /**
     * A special message type that is used to replace event filtered already at {@link MessageDecoder}. Enables
     * {@link PostgresStreamingChangeEventSource} to advance LSN forward even in case of such messages.
     */
