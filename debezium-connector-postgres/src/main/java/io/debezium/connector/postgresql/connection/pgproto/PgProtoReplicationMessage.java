...
/**
 * Replication message representing message sent by <a href="https://github.com/debezium/postgres-decoderbufs">Postgres
 * Decoderbufs</>
 *
...
class PgProtoReplicationMessage implements ReplicationMessage {
    ...
    private List<ReplicationMessage.Column> transform(List<PgProto.DatumMessage> messageList,
        ...
        return IntStream.range(0, messageList.size()).mapToObj(index -> {
            ...
            final Optional<PgProto.TypeInfo> typeInfo = Optional
                    .ofNullable(hasTypeMetadata() && typeInfoList != null ? typeInfoList.get(index) : null);
            ...
            if (datum.hasDatumMissing()) {
                return new UnchangedToastedReplicationMessageColumn(columnName, type,
            ...
            return new AbstractReplicationMessageColumn(columnName, type, fullType,
                ...
                public Object getValue(PgConnectionSupplier connection, boolean includeUnknownDatatypes) {
                    return PgProtoReplicationMessage.this.getValue(columnName, type, fullType, datum, connection,
