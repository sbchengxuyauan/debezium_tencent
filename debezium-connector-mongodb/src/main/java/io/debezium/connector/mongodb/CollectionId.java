...
public final class CollectionId implements DataCollectionId {
    ...
    /**
     * Parse the supplied {@code <database_name>.<collection_name>} string. The {@code collection_name} can also contain
     * dots in its value.
     *
     * @param replicaSetName
     *            the name of replica; may not be null
     * @param str
     *            the string representation of the collection identifier; may not be null
     ...
     *
     * @param replicaSetName
     *            the name of the replica set; may not be null
     * @param dbName
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CollectionId) {
            ...
            return this.replicaSetName.equals(that.replicaSetName) && this.dbName.equals(that.dbName)
    ...
    /**
     * Get the namespace of this collection, which is comprised of the {@link #dbName database name} and {@link #name
     * collection name}.
     *
