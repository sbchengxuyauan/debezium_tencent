...
public class MongoDbTopicSelector {
     ...
     *
     * @param prefix
     *            the prefix; be null or empty if no prefix is needed
     * @param heartbeatPrefix
     *            the name of the prefix to be used for all heartbeat topics; may not be null and must not terminate in
     *            the {@code delimiter}
     ...
     *
     * @param delimiter
     *            the string delineating the prefix, database, and collection names; may not be null
     * @param prefix
     *            the prefix; be null or empty if no prefix is needed
     * @return the topic selector; never null
     */
