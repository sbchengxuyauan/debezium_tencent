...
public final class Filters {
    ...
    public Filters(Configuration config) {
        ...
        fieldSelector = FieldSelector.builder().excludeFields(config.getString(MongoDbConnectorConfig.FIELD_BLACKLIST))
                .renameFields(config.getString(MongoDbConnectorConfig.FIELD_RENAMES)).build();
    }
     ...
     *
     * @param id
     *            the collection identifier, never null
