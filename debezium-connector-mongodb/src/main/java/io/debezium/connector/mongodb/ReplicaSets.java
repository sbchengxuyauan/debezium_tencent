...
public class ReplicaSets {
    ...
    /**
     * Parse the supplied string for the information about the replica set hosts. The string is a semicolon-delimited
     * list of shard hosts (e.g., "{@code shard01=replicaSet1/host1:27017,host2:27017}"), replica set hosts (e.g.,
     * "{@code replicaSet1/host1:27017,host2:27017}"), and standalone hosts (e.g., "{@code host1:27017}" or
     * "{@code 1.2.3.4:27017}").
     *
     * @param hosts
     *            the hosts string; may be null
     ...
     *
     * @param rsSpecs
     *            the replica set specifications; may be null or empty
     */
     ...
     *
     * @param maxSubdivisionCount
     *            the maximum number of subdivisions
     * @param subdivisionConsumer
     *            the function to be called with each subdivision; may not be null
     */
     ...
     *
     * @param priorState
     *            the prior state of the replica sets; may be null
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ReplicaSets) {
            ...
            return this.replicaSetsByName.equals(that.replicaSetsByName)
                    && this.nonReplicaSets.equals(that.nonReplicaSets);
        }
        return false;
    }
