...
public class MongoDbSourceInfoStructMaker extends AbstractSourceInfoStructMaker<SourceInfo> {
    ...
    public MongoDbSourceInfoStructMaker(String connector, String version, CommonConnectorConfig connectorConfig) {
        ...
        schema = commonSchemaBuilder()
                ...
                .field(SourceInfo.COLLECTION, Schema.STRING_SCHEMA).field(SourceInfo.ORDER, Schema.INT32_SCHEMA)
                .field(SourceInfo.OPERATION_ID, Schema.OPTIONAL_INT64_SCHEMA)
                .field(SourceInfo.TX_ORD, Schema.OPTIONAL_INT64_SCHEMA).build();
    }
    ...
    public Struct struct(SourceInfo sourceInfo) {
        Struct struct = super.commonStruct(sourceInfo).put(SourceInfo.REPLICA_SET_NAME, sourceInfo.replicaSetName())
        ...
        sourceInfo.transactionPosition()
                .ifPresent(transactionPosition -> struct.put(SourceInfo.TX_ORD, transactionPosition));
