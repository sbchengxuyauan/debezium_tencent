 ...
 *
 * The mongodb connector operates multiple threads during snapshot and streaming modes where each {@link ReplicaSet} is
 * processed individually and the offsets that pertain to that {@link ReplicaSet} should be maintained in such a way
 * that is considered thread-safe. This implementation offers such safety.
 *
