...
public final class FieldSelector {
    ...
    public static interface FieldFilter {
         ...
         *
         * @param doc
         *            document to exclude or rename fields
    ...
    public static class FieldSelectorBuilder {
         ...
         *
         * @param fullyQualifiedFieldNames
         *            the comma-separated list of fully-qualified field names to exclude; may be {@code null} or empty
         ...
         *
         * @param fullyQualifiedFieldReplacements
         *            the comma-separated list of fully-qualified field replacements to rename fields; may be
         *            {@code null} or empty
         * @return this builder so that methods can be chained together; never {@code null}
         */
        ...
        /**
         * Builds the filter selector that returns the field filter for a given collection identifier, using the
         * comma-separated list of fully-qualified field names (for details, see
         * {@link MongoDbConnectorConfig#FIELD_BLACKLIST}) defining which fields (if any) should be excluded, and using
         * the comma-separated list of fully-qualified field replacements (for details, see
         * {@link MongoDbConnectorConfig#FIELD_RENAMES}) defining which fields (if any) should be renamed.
         *
        ...
        public FieldSelector build() {
            ...
            parse(fullyQualifiedFieldReplacements, name -> {
                ...
                return new RenamePath(selectNamespacePartAsPattern(nameNodes), selectFieldPartAsNodes(nameNodes),
                        replacement[1]);
            }, result);
        ...
        private String[] parseIntoParts(String name, String value, Predicate<Integer> lengthPredicate,
     ...
     *
     * <p>
     * Note that the field filter is completely independent of the collection selection predicate, so it is expected
     * that this filter be used only after the collection selection predicate determined the collection containing
     * documents with the field(s) is to be used.
     *
     * @param id
     *            the collection identifier, never {@code null}
     * @return the field filter, never {@code null}
     */
    public FieldFilter fieldFilterFor(CollectionId id) {
        if (!paths.isEmpty()) {
            String namespace = id.namespace();
            List<Path> pathsApplyingToCollection = paths.stream().filter(path -> path.matches(namespace))
    ...
    private static abstract class Path {
         ...
         *
         * @param doc
         *            the original document; never {@code null}
         * @param setDoc
         *            the value of {@code $set} field; may be {@code null}
         * @param unsetDoc
         *            the value of {@code $unset} field; may be {@code null}
         */
         ...
         *
         * <p>
         * First, we try to modify field that exactly matches the current path. Then, if the field isn't found, we try
         * to find fields that start with the current path or fields that are part of the current path.
         *
         * @param doc
         *            the document to modify fields
         */
         ...
         *
         * @param items
         *            the array to exclude numeric items
         ...
         *
         * @param begin
         *            the array from which the source array begins
         * @param source
    ...
    private static final class RenamePath extends Path {
        ...
        /**
         * Replaces a last name node in the given name nodes, if the name nodes contain only one node, the last name
         * node is returned.
         *
         * @param nameNodes
         *            the name nodes to replace
         * @param lastNameNode
         *            the last name node
