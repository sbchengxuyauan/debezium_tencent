...
/**
 * Defines the Kafka Connect {@link Schema} functionality associated with a given mongodb collection, and which can be
 * used to send documents that match the schema to Kafka Connect.
 *
...
public class MongoDbCollectionSchema implements DataCollectionSchema {
    ...
    public MongoDbCollectionSchema(CollectionId id, FieldFilter fieldFilter, Schema keySchema,
            Function<Document, Object> keyGenerator, Envelope envelopeSchema, Schema valueSchema,
