...
public class ExtractNewDocumentStateArrayOperatorTestIT extends AbstractExtractNewDocumentStateUpdateOperatorsTestIT {
    ...
    /**
     * @see <a href="https://docs.mongodb.com/v3.6/reference/operator/update/addToSet/#up._S_addToSet">MongoDB operator
     *      array update $addToSet</a>
     */
    @Test
    ...
    /**
     * @see <a href="https://docs.mongodb.com/v3.6/reference/operator/update/pop/#up._S_pop">MongoDB operator array
     *      update $pop</a>
     */
    @Test
    ...
    /**
     * @see <a href="https://docs.mongodb.com/v3.6/reference/operator/update/pull/#pull">MongoDB operator array update
     *      $pull</a>
     */
    @Test
    ...
    /**
     * @see <a href="https://docs.mongodb.com/v3.6/reference/operator/update/pullAll/#up._S_pullAll">MongoDB operator
     *      array update $pullAll</a>
     */
    @Test
    ...
    /**
     * @see <a href="https://docs.mongodb.com/v3.6/reference/operator/update/push/#push">MongoDB operator array update
     *      $push</a>
     */
    @Test
    public void shouldTransformOperationPush() throws InterruptedException {
        ...
        // Operations which include items to arrays result in a new field where the structure looks like
        // "FIELD_NAME.ARRAY_INDEX"
        VerifyRecord.assertConnectSchemasAreEqual("id", valueSchema.field("id").schema(), Schema.OPTIONAL_INT32_SCHEMA);
        VerifyRecord.assertConnectSchemasAreEqual("dataArrayOfStr.3", valueSchema.field("dataArrayOfStr.3").schema(),
