...
public class ToAvroMongoDataConverterTest {
    ...
    public void shouldCreateStructWithNestedObject() {
        ...
        assertThat(avro.toString())
                .isEqualTo("{\"_id\": 1, " + "\"s1\": {\"s1f1\": \"field1s1\", \"s1f2\": \"field2s1\"}, "
    ...
    public void shouldCreateSchemaWithNestedObject() {
        ...
        assertThat(avroSchema.toString()).isEqualTo("{\"type\":\"record\",\"name\":\"complex\",\"fields\":["
                ...
                + "\"connect.name\":\"complex.s2\"}],\"default\":null}]," + "\"connect.name\":\"complex\"}");
    }
