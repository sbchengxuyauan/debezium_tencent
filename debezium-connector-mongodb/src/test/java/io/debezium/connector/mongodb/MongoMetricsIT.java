...
public class MongoMetricsIT extends AbstractMongoConnectorIT {
    ...
    public void testLifecycle() throws Exception {
        // Setup
        this.config = TestHelper.getConfiguration().edit()
                .with(MongoDbConnectorConfig.SNAPSHOT_MODE, MongoDbConnectorConfig.SnapshotMode.INITIAL)
                .with(MongoDbConnectorConfig.COLLECTION_WHITELIST, "dbit.*").build();
    ...
    public void testSnapshotOnlyMetrics() throws Exception {
        ...
        assertThat(mBeanServer.getAttribute(objectName, "MonitoredTables"))
                .isEqualTo(new String[] { "rs0.dbit.restaurants" });
