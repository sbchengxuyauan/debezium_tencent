    ...
    public Map<String, String> start() {
        try {
            ...
            container = new FixedHostPortGenericContainer(POSTGRES_IMAGE)
                    ...
                    .withEnv("POSTGRES_USER", POSTGRES_USER).withEnv("POSTGRES_PASSWORD", POSTGRES_PASSWORD)
                    .withEnv("POSTGRES_DB", POSTGRES_DBNAME).withEnv("POSTGRES_INITDB_ARGS", "-E UTF8")
                    .withEnv("LANG", "en_US.utf8").withStartupTimeout(Duration.ofSeconds(30));
