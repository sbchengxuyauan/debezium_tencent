...
/**
 * Smoke test that verifies the Debezium Outbox extension started successfully and created the Outbox database table
 * with the expected properties and return types.
 *
...
public class OutboxTest {
    ...
    public void testOutboxEntityMetamodelExists() throws Exception {
        final MetamodelImplementor metadata = entityManager.unwrap(SessionImplementor.class).getFactory()
                .getMetamodel();
