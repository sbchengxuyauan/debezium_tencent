...
/**
 * An {@link AdditionalJaxbMappingProducer} implementation that provides Hibernate ORM with a HBM XML mapping for an
 * map-mode entity configuration for the OutboxEvent entity data type.
 *
 * @author Chris Cranford
 */
public class AdditionalJaxbMappingProducerImpl implements AdditionalJaxbMappingProducer {
    @Override
    public Collection<MappingDocument> produceAdditionalMappings(MetadataImplementor metadata, IndexView jandexIndex,
