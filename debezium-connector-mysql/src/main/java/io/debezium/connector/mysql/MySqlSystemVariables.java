...
public class MySqlSystemVariables extends SystemVariables {
    ...
    /**
     * The system variable name for the name of the character set that the server uses by default. See
    ...
    /**
     * The system variable name to see if the MySQL tables are stored and looked-up in case sensitive way. See
