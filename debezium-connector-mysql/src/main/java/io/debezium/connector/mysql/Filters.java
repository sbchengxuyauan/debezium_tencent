...
public class Filters {
    ...
    protected static final Set<String> BUILT_IN_DB_NAMES = Collect.unmodifiableSet("mysql", "performance_schema", "sys",
            "information_schema");
    ...
    private Filters(Predicate<String> dbFilter, Predicate<TableId> tableFilter, Predicate<String> isBuiltInDb,
            Predicate<TableId> isBuiltInTable, ColumnNameFilter columnFilter) {
    ...
    public static class Builder {
        ...
        /**
         * Create a Builder for a filter. Set the initial filter data to match the filter data in the given
         * configuration.
         * 
         * @param config
        ...
        /**
         * Completely reset the filter to match the filter info in the given offsets. This will completely reset the
         * filters to those passed in.
         * 
         * @param offsets
         *            The offsets to set the filter info to.
         * @return this
         */
        ...
        private void setFiltersFromStrings(String dbWhitelist, String dbBlacklist, String tableWhitelist,
                String tableBlacklist) {
            Predicate<String> dbFilter = Selectors.databaseSelector().includeDatabases(dbWhitelist)
                    .excludeDatabases(dbBlacklist).build();

            // Define the filter using the whitelists and blacklists for tables and database names ...
            Predicate<TableId> tableFilter = Selectors.tableSelector().includeDatabases(dbWhitelist)
                    .excludeDatabases(dbBlacklist).includeTables(tableWhitelist).excludeTables(tableBlacklist).build();
        ...
        /**
         * Include all the databases that the given predicate tests as true for. All databases previously included will
         * still be included.
         * 
         * @param databases
         *            the databases to be included
         * @return
         */
        ...
        /**
         * Include the tables that the given predicate tests as true for. Tables previously included will still be
         * included.
         * 
         * @param tables
        ...
        public Filters build() {
            return new Filters(this.dbFilter, this.tableFilter, this.isBuiltInDb, this.isBuiltInTable,
                    this.columnFilter);
        }
    }
}
