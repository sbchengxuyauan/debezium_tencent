...
/**
 * Parser listener for MySQL column definition queries. Its purpose is to delegate events to defined collection of
 * concrete parser listeners. Each listener handles the specified type of DDL statement.
 * <p>
...
public class MySqlAntlrDdlParserListener extends MySqlParserBaseListener implements AntlrDdlParserListener {
    ...
    /**
     * Count of skipped nodes. Each enter event during skipping phase will increase the counter and each exit event will
     * decrease it. When counter will be decreased to 0, the skipping phase will end.
     */
