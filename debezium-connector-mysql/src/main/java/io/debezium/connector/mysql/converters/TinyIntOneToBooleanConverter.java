 ...
 * {@code DESCRIBE CREATE TABLE}. This custom converter allows user to handle all {@code TINYINT(1)} fields as
 * {@code BOOLEAN} or provide a set of regexes to match only subset of tables/columns.
 *
