...
/**
 * This class is used by a DDL parser to convert the string default value to a Java type recognized by value converters
 * for a subset of types. The functionality is kept separate from the main converters to centralize the formatting logic
 * if necessary.
 *
...
public class MySqlDefaultValueConverter {
    ...
    private static final Pattern EPOCH_EQUIVALENT_TIMESTAMP = Pattern
            .compile("(\\d{4}-\\d{2}-00|\\d{4}-00-\\d{2}|0000-\\d{2}-\\d{2}) (00:00:00(\\.\\d{1,6})?)");

    private static final Pattern EPOCH_EQUIVALENT_DATE = Pattern
            .compile("\\d{4}-\\d{2}-00|\\d{4}-00-\\d{2}|0000-\\d{2}-\\d{2}");
     ...
     *            column definition
     * @param value
     *            string formatted default value
    ...
    /**
     * Converts a string object for an object type of {@link LocalDate}. If the column definition allows null and
     * default value is 0000-00-00, we need return null; else 0000-00-00 will be replaced with 1970-01-01;
     *
     * @param column
     *            the column definition describing the {@code data} value; never null
     * @param value
     *            the string object to be converted into a {@link LocalDate} type;
    ...
    /**
     * Converts a string object for an object type of {@link LocalDateTime}. If the column definition allows null and
     * default value is 0000-00-00 00:00:00, we need return null, else 0000-00-00 00:00:00 will be replaced with
     * 1970-01-01 00:00:00;
     *
     * @param column
     *            the column definition describing the {@code data} value; never null
     * @param value
     *            the string object to be converted into a {@link LocalDateTime} type;
     * @return the converted value;
     */
    ...
    /**
     * Converts a string object for an object type of {@link Timestamp}. If the column definition allows null and
     * default value is 0000-00-00 00:00:00, we need return null, else 0000-00-00 00:00:00 will be replaced with
     * 1970-01-01 00:00:00;
     *
     * @param column
     *            the column definition describing the {@code data} value; never null
     * @param value
     *            the string object to be converted into a {@link Timestamp} type;
     * @return the converted value;
     */
     ...
     *            the column definition describing the {@code data} value; never null
     * @param value
     *            the string object to be converted into a {@link Duration} type;
     * @return the converted value;
     */
     ...
     *
     * @param value
     *            the string object to be converted into a {@link Types#DOUBLE} type;
     * @return the converted value;
     */
     ...
     *            the column definition describing the {@code data} value; never null
     * @param value
     *            the string object to be converted into a {@link Types#DECIMAL} type;
     * @return the converted value;
     */
     ...
     *            the column definition describing the {@code data} value; never null
     * @param value
     *            the string object to be converted into a {@link Types#BIT} type;
     * @return the converted value;
     */
     ...
     * 
     * @param value
     *            the string object to be converted into a {@link Types#BOOLEAN} type;
     *
     * @return the converted value;
     */
