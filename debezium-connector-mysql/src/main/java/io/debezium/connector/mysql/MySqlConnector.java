        ...
        if (hostnameValue.errorMessages().isEmpty() && portValue.errorMessages().isEmpty()
            ...
            try (MySqlJdbcContext jdbcContext = new MySqlJdbcContext(new MySqlConnectorConfig(config))) {
                ...
                try {
                    ...
                    logger.info("Successfully tested connection for {} with user '{}'", jdbcContext.connectionString(),
                            mysql.username());
                } catch (SQLException e) {
                    logger.info("Failed testing connection for {} with user '{}'", jdbcContext.connectionString(),
                            mysql.username());
