...
/**
 * A set of MySQL GTIDs. This is an improvement of {@link com.github.shyiko.mysql.binlog.GtidSet} that is immutable, and
...
public final class GtidSet {
    ...
    /**
     * @param gtids
     *            the string representation of the GTIDs.
     */
    ...
    /**
     * Obtain a copy of this {@link GtidSet} except with only the GTID ranges that have server UUIDs that match the
     * given predicate.
     *
     * @param sourceFilter
     *            the predicate that returns whether a server UUID is to be included
    ...
    public GtidSet retainAll(Predicate<String> sourceFilter) {
        ...
        Map<String, UUIDSet> newSets = this.uuidSetsByServerId.entrySet().stream()
     ...
     * @return {@code true} if all of the GTIDs in this set are completely contained within the supplied set of GTIDs,
    ...
    /**
     * Obtain a copy of this {@link GtidSet} except overwritten with all of the GTID ranges in the supplied
     * {@link GtidSet}.
     * 
     * @param other
     *            the other {@link GtidSet} with ranges to add/overwrite on top of those in this set;
    ...
    public static class UUIDSet {
         ...
         * @return {@code true} if this server's transaction numbers are a subset of the transaction numbers of the
         *         supplied set, or false otherwise
         */
