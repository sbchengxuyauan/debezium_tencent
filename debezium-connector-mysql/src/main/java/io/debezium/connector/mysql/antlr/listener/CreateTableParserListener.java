...
public class CreateTableParserListener extends MySqlParserBaseListener {
    ...
    public void exitColumnCreateTable(MySqlParser.ColumnCreateTableContext ctx) {
        parser.runIfNotNull(() -> {
            ...
            tableEditor.setColumns(tableEditor.columns().stream().map(column -> {
    ...
    public void exitCopyCreateTable(MySqlParser.CopyCreateTableContext ctx) {
        ...
        if (original != null) {
            parser.databaseTables().overwriteTable(tableId, original.columns(), original.primaryKeyColumnNames(),
        ...
        parser.runIfNotNull(() -> {
            ...
            if (columnDefinitionListener == null) {
                columnDefinitionListener = new ColumnDefinitionParserListener(tableEditor, columnEditor,
                        parser.dataTypeResolver(), parser.getConverters(), false);
