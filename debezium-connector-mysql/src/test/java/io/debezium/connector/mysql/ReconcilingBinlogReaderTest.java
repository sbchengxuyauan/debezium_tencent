...
public class ReconcilingBinlogReaderTest {
    ...
    public void haltAfterPredicateTrue() {
        ...
        ReconcilingBinlogReader.OffsetLimitPredicate offsetLimitPredicate = new ReconcilingBinlogReader.OffsetLimitPredicate(
                offsets.get(1), (x) -> true);
     ...
     * 
     * @param size
     *            the number of offsets to create.
     * @return
     */
