...
public class MySqlEnumColumnIT extends AbstractConnectorTest {
    ...
    private static final Path DB_HISTORY_PATH = Testing.Files.createTestingPath("file-db-history-enum-column.txt")
            .toAbsolutePath();
    private final UniqueDatabase DATABASE = new UniqueDatabase("enumcolumnit", "enum_column_test")
    ...
    public void shouldAlterEnumColumnCharacterSet() throws Exception {
        ...
        config = DATABASE.defaultConfig()
                ...
                .with(MySqlConnectorConfig.TABLE_WHITELIST, DATABASE.qualifiedTableName("test_stations_10")).build();
