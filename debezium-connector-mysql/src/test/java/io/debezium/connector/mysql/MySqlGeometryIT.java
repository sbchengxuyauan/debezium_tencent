...
public class MySqlGeometryIT extends AbstractConnectorTest {
    ...
    public void shouldConsumeAllEventsFromDatabaseUsingBinlogAndNoSnapshot() throws SQLException, InterruptedException {
        ...
        assertThat(records.recordsForTopic(DATABASE.topicForTable("dbz_222_point")).size())
    ...
    private void assertPoint(Struct value) {
        ...
        if (after.getStruct("point") != null) {
            ...
            // Test WKB
            Point point = (Point) WkbGeometryReader
                    .readGeometry(new ByteReader((byte[]) after.getStruct("point").get("wkb")));
    ...
    private void assertGeomRecord(Struct value) {
        ...
        assertThat(i).isNotNull();
        if (i == 1) {
            // INSERT INTO dbz_507_geometry VALUES (1, ST_GeomFromText('POINT(1 1)', 4326),
            // ST_GeomFromText('LINESTRING(0 0, 1 1)', 3187), ST_GeomFromText('POLYGON((0 0, 1 1, 1 0, 0 0))'),
            ...
            assertThat(DatatypeConverter.printHexBinary(after.getStruct("geom").getBytes("wkb")))
                    .isEqualTo("0101000000000000000000F03F000000000000F03F");
