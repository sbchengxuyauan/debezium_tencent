...
public class MySqlGeometryTest {
    ...
    public void shouldConvertMySqlBytesToLine() throws Exception {
        byte[] mysqlBytes = DatatypeConverter.parseHexBinary(
                "E6100000010200000002000000E3A59BC420F01B4015A143A69D38324000000000000000000000000000000000");
        ...
        assertEquals("010200000002000000E3A59BC420F01B4015A143A69D38324000000000000000000000000000000000",
    ...
    public void shouldConvertMySqlBytesToMultiGeometry() throws Exception {
        byte[] mysqlBytes = DatatypeConverter.parseHexBinary(
                "000000000104000000020000000101000000000000000000F03F000000000000F03F010100000000000000000000400000000000000040");
