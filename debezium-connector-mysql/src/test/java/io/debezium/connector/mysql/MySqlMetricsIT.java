...
public class MySqlMetricsIT extends AbstractConnectorTest {
    ...
    private static final Path DB_HISTORY_PATH = Testing.Files.createTestingPath("file-db-history-metrics.txt")
            .toAbsolutePath();
    private static final String SERVER_NAME = "myserver";
    private final UniqueDatabase DATABASE = new UniqueDatabase(SERVER_NAME, "connector_metrics_test")
    ...
    public void testLifecycle() throws Exception {
        ...
        start(MySqlConnector.class,
                DATABASE.defaultConfig().with(MySqlConnectorConfig.SNAPSHOT_MODE, SnapshotMode.INITIAL)
                        ...
                        .with(DatabaseHistory.STORE_ONLY_MONITORED_TABLES_DDL, Boolean.TRUE).build());
    ...
    public void testSnapshotOnlyMetrics() throws Exception {
        ...
        // start connector
        start(MySqlConnector.class,
                DATABASE.defaultConfig().with(MySqlConnectorConfig.SNAPSHOT_MODE, SnapshotMode.INITIAL_ONLY)
                        .with(MySqlConnectorConfig.DATABASE_HISTORY, FileDatabaseHistory.class)
                        .with(FileDatabaseHistory.FILE_PATH, DB_HISTORY_PATH)
                        .with(MySqlConnectorConfig.TABLE_WHITELIST, DATABASE.qualifiedTableName("simple"))
                        .with(MySqlConnectorConfig.TABLES_IGNORE_BUILTIN, Boolean.TRUE)
    ...
    public void testStreamingOnlyMetrics() throws Exception {
        // start connector
        start(MySqlConnector.class,
                DATABASE.defaultConfig().with(MySqlConnectorConfig.SNAPSHOT_MODE, SnapshotMode.NEVER)
                        .with(MySqlConnectorConfig.DATABASE_HISTORY, FileDatabaseHistory.class)
                        .with(FileDatabaseHistory.FILE_PATH, DB_HISTORY_PATH)
                        .with(MySqlConnectorConfig.TABLE_WHITELIST, DATABASE.qualifiedTableName("simple"))
                        .with(MySqlConnectorConfig.TABLES_IGNORE_BUILTIN, Boolean.TRUE)
    ...
    private void assertSnapshotMetrics() throws Exception {
        ...
        // assertThat(mBeanServer.getAttribute(getSnapshotMetricsObjectName(),
        // "TotalNumberOfEventsSeen")).isEqualTo(0L);
