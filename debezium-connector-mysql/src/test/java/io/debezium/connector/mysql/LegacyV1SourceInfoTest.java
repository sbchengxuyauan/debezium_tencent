...
public class LegacyV1SourceInfoTest {
    ...
    public void beforeEach() {
        source = new SourceInfo(
                new MySqlConnectorConfig(Configuration.create().with(MySqlConnectorConfig.SERVER_NAME, "server")
                        .with(MySqlConnectorConfig.SOURCE_STRUCT_MAKER_VERSION, Version.V1).build()));
        inTxn = false;
    ...
    public void setOffsetFilterFromFilter() {
        ...
        final Configuration configuration = Configuration.create()
                ...
                .with(MySqlConnectorConfig.TABLE_BLACKLIST, tableBlacklist).build();
    ...
    protected SourceInfo sourceWith(Map<String, String> offset) {
        source = new SourceInfo(
                new MySqlConnectorConfig(Configuration.create().with(MySqlConnectorConfig.SERVER_NAME, SERVER_NAME)
                        .with(MySqlConnectorConfig.SOURCE_STRUCT_MAKER_VERSION, Version.V1).build()));
    ...
    /**
     * When we want to consume SinkRecord which generated by debezium-connector-mysql, it should not throw error
     * "org.apache.avro.SchemaParseException: Illegal character in: server-id"
     */
    @Test
    ...
    public void shouldConsiderPositionsWithSameGtidSetsAsSame() {
        ...
        assertPositionWithGtids("IdA:1-5,IdB:1-20").isAtOrBefore(positionWithGtids("IdA:1-5,IdB:1-20")); // same,
                                                                                                         // multiple
    ...
    public void shouldOrderPositionWithGtidAndSnapshotBeforePositionWithSameGtidButNoSnapshot() {
        ...
        assertPositionWithGtids("IdA:1-5,IdB:1-20", true).isAtOrBefore(positionWithGtids("IdA:1-5,IdB:1-20")); // same,
                                                                                                               // multiple
    ...
    public void shouldOrderPositionWithoutGtidAndSnapshotAfterPositionWithSameGtidAndSnapshot() {
        ...
        assertPositionWithGtids("IdA:1-5,IdB:1-20", false).isAfter(positionWithGtids("IdA:1-5,IdB:1-20", true)); // same,
                                                                                                                 // multiple
    ...
    public void shouldComparePositionsWithDifferentFields() {
        Document history = positionWith("mysql-bin.000008", 380941551,
                "01261278-6ade-11e6-b36a-42010af00790:1-378422946," + "4d1a4918-44ba-11e6-bf12-42010af0040b:1-11002284,"
                        + "716ec46f-d522-11e5-bb56-0242ac110004:1-34673215,"
                        + "96c2072e-e428-11e6-9590-42010a28002d:1-3,"
                        + "c627b2bc-9647-11e6-a886-42010af0044a:1-9541144",
                0, 0, true);
        Document current = positionWith("mysql-bin.000016", 645115324,
                "01261278-6ade-11e6-b36a-42010af00790:1-400944168," + "30efb117-e42a-11e6-ba9e-42010a28002e:1-9,"
    ...
    public void shouldRemoveNewlinesFromGtidSet() {
        ...
        String gtidCleaned = "036d85a9-64e5-11e6-9b48-42010af0000c:1-2,"
                + "7145bf69-d1ca-11e5-a588-0242ac110004:1-3149," + "7c1de3f2-3fd2-11e6-9cdc-42010af000bc:1-39";
    ...
    public void schemaIsCorrect() {
        final Schema schema = SchemaBuilder.struct().name("io.debezium.connector.mysql.Source")
                .field("version", Schema.OPTIONAL_STRING_SCHEMA).field("connector", Schema.OPTIONAL_STRING_SCHEMA)
                .field("name", Schema.STRING_SCHEMA).field("server_id", Schema.INT64_SCHEMA)
                .field("ts_sec", Schema.INT64_SCHEMA).field("gtid", Schema.OPTIONAL_STRING_SCHEMA)
                .field("file", Schema.STRING_SCHEMA).field("pos", Schema.INT64_SCHEMA).field("row", Schema.INT32_SCHEMA)
                .field("snapshot", SchemaBuilder.bool().optional().defaultValue(false).build())
                .field("thread", Schema.OPTIONAL_INT64_SCHEMA).field("db", Schema.OPTIONAL_STRING_SCHEMA)
                .field("table", Schema.OPTIONAL_STRING_SCHEMA).field("query", Schema.OPTIONAL_STRING_SCHEMA).build();
