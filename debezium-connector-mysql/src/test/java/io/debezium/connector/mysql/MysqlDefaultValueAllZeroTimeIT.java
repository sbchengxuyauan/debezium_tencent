...
public class MysqlDefaultValueAllZeroTimeIT extends AbstractConnectorTest {
    ...
    public void allZeroDateAndTimeTypeTest() throws InterruptedException {
        ...
        final SourceRecord record = records.recordsForTopic(DATABASE.topicForTable("ALL_ZERO_DATE_AND_TIME_TABLE"))
                .get(0);
        ...
        long toEpochMillisE = Timestamp.toEpochMillis(
                LocalDateTime.from(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss").parse(valueE)),
