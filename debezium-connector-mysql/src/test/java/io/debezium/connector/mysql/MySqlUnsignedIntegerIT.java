...
public class MySqlUnsignedIntegerIT extends AbstractConnectorTest {
    ...
    public void shouldConsumeAllEventsFromDatabaseUsingBinlogAndNoSnapshot() throws SQLException, InterruptedException {
        ...
        config = DATABASE.defaultConfig()
                ...
                .with(MySqlConnectorConfig.BIGINT_UNSIGNED_HANDLING_MODE,
                        MySqlConnectorConfig.BigIntUnsignedHandlingMode.PRECISE)
                .build();
    ...
    @Test
    @FixFor("DBZ-363")
    public void shouldConsumeAllEventsFromBigIntTableInDatabaseUsingBinlogAndNoSnapshotUsingLong()
            throws SQLException, InterruptedException {
        // Use the DB configuration to define the connector's configuration ...
        config = DATABASE.defaultConfig()
                .with(MySqlConnectorConfig.SNAPSHOT_MODE, MySqlConnectorConfig.SnapshotMode.NEVER.toString())
                .with(MySqlConnectorConfig.BIGINT_UNSIGNED_HANDLING_MODE,
                        MySqlConnectorConfig.BigIntUnsignedHandlingMode.LONG)
                .build();
        // Start the connector ...
        start(MySqlConnector.class, config);
    ...
    private void assertTinyintUnsigned(Struct value) {
        ...
        // Note: the recommended mapping of Signed TINYINT is Short which is 16-bit.
    ...
    private void assertBigintUnsignedPrecise(Struct value) {
        ...
        Integer i = after.getInt32("id");
        assertThat(i).isNotNull();
        // Validate the schema first, we are expecting org.apache.kafka.connect.data.Decimal:Byte since we are dealing
        // with unsignd-bigint
    ...
    private void assertBigintUnsignedLong(Struct value) {
        ...
        // Validate candidates values, note the loss in precision which is expected since BIGINT UNSIGNED cannot always
        // be represented by
        // a long datatype.
        switch (i) {
        case 1:
    ...
    private void assertSerialPrecise(List<SourceRecord> records) {
        final BigDecimal[] expected = new BigDecimal[] { new BigDecimal(10), new BigDecimal(11),
