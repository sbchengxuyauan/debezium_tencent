...
/**
 * A logical representation of change table containing changes for a given source table. There is usually one change
 * table for each source table. When the schema of the source table is changed then two change tables could be present.
 *
...
public class ChangeTable {
    ...
    public ChangeTable(TableId sourceTableId, String captureInstance, int changeTableObjectId, Lsn startLsn,
            Lsn stopLsn) {
        super();
        ...
        this.changeTableId = sourceTableId != null
                ? new TableId(sourceTableId.catalog(), CDC_SCHEMA, captureInstance + "_CT") : null;
    }
    ...
    public String toString() {
        return "Capture instance \"" + captureInstance + "\" [sourceTableId=" + sourceTableId + ", changeTableId="
                + changeTableId + ", startLsn=" + startLsn + ", changeTableObjectId=" + changeTableObjectId
                + ", stopLsn=" + stopLsn + "]";
    }
}
