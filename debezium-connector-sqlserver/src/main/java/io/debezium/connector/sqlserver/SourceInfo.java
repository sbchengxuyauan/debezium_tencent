...
public class SourceInfo extends BaseSourceInfo {
    ...
    /**
     * @param lsn
     *            - LSN of the change in the database log
     */
    ...
    /**
     * @param commitLsn
     *            - LSN of the {@code COMMIT} of the transaction whose part the change is
     */
    ...
    /**
     * @param eventSerialNo
     *            order of the change with the same value of commit and change LSN
     */
    ...
    /**
     * @param instant
     *            a time at which the transaction commit was executed
     */
    ...
    public String toString() {
        return "SourceInfo [" + "serverName=" + serverName() + ", changeLsn=" + changeLsn + ", commitLsn=" + commitLsn
                + ", eventSerialNo=" + eventSerialNo + ", snapshot=" + snapshotRecord + ", sourceTime=" + sourceTime
                + "]";
    }
