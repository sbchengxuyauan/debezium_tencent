...
/**
 * A logical representation of SQL Server LSN (log sequence number) position. When LSN is not available it is replaced
 * with {@link Lsn.NULL} constant.
 *
