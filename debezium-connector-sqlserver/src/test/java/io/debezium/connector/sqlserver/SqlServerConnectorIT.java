...
public class SqlServerConnectorIT extends AbstractConnectorTest {
    ...
    public void before() throws SQLException {
        ...
        connection.execute("CREATE TABLE tablea (id int primary key, cola varchar(30))",
                "CREATE TABLE tableb (id int primary key, colb varchar(30))", "INSERT INTO tablea VALUES(1, 'a')");
    ...
    public void createAndDelete() throws Exception {
        ...
        final Configuration config = TestHelper.defaultConfig()
                .with(SqlServerConnectorConfig.SNAPSHOT_MODE, SnapshotMode.INITIAL).build();
    ...
    public void readOnlyApplicationIntent() throws Exception {
        ...
        final Configuration config = TestHelper.defaultConfig()
                ...
                .with("database.applicationIntent", "ReadOnly").with("database.applicationName", appId).build();
    ...
    public void deleteWithoutTombstone() throws Exception {
        ...
        final Configuration config = TestHelper.defaultConfig()
                .with(SqlServerConnectorConfig.SNAPSHOT_MODE, SnapshotMode.INITIAL)
                .with(SqlServerConnectorConfig.TOMBSTONES_ON_DELETE, false).build();
    ...
    public void updatePrimaryKey() throws Exception {
        ...
        final List<SchemaAndValueField> expectedDeleteRowA = Arrays.asList(
                ...
                new SchemaAndValueField("cola", Schema.OPTIONAL_STRING_SCHEMA, "a"));
        final List<SchemaAndValueField> expectedDeleteKeyA = Arrays
                .asList(new SchemaAndValueField("id", Schema.INT32_SCHEMA, 1));
        final List<SchemaAndValueField> expectedInsertRowA = Arrays.asList(
                new SchemaAndValueField("id", Schema.INT32_SCHEMA, 100),
                new SchemaAndValueField("cola", Schema.OPTIONAL_STRING_SCHEMA, "a"));
        final List<SchemaAndValueField> expectedInsertKeyA = Arrays
                .asList(new SchemaAndValueField("id", Schema.INT32_SCHEMA, 100));
        ...
        final List<SchemaAndValueField> expectedDeleteRowB = Arrays.asList(
                new SchemaAndValueField("id", Schema.INT32_SCHEMA, 1),
                new SchemaAndValueField("colb", Schema.OPTIONAL_STRING_SCHEMA, "b"));
        final List<SchemaAndValueField> expectedDeleteKeyB = Arrays
                .asList(new SchemaAndValueField("id", Schema.INT32_SCHEMA, 1));
        final List<SchemaAndValueField> expectedInsertRowB = Arrays.asList(
                new SchemaAndValueField("id", Schema.INT32_SCHEMA, 100),
                new SchemaAndValueField("colb", Schema.OPTIONAL_STRING_SCHEMA, "b"));
        final List<SchemaAndValueField> expectedInsertKeyB = Arrays
                .asList(new SchemaAndValueField("id", Schema.INT32_SCHEMA, 100));
    ...
    public void updatePrimaryKeyWithRestartInMiddle() throws Exception {
        ...
        start(SqlServerConnector.class, config, record -> {
            ...
            return envelope != null && "c".equals(envelope.get("op"))
                    && (envelope.getStruct("after").getInt32("id") == 100);
        });
        assertConnectorIsRunning();
    ...
    public void whitelistTable() throws Exception {
        ...
        final Configuration config = TestHelper.defaultConfig()
                ...
                .with(SqlServerConnectorConfig.TABLE_WHITELIST, "dbo.tableb").build();
        connection.execute("INSERT INTO tableb VALUES(1, 'b')");
    ...
    public void blacklistTable() throws Exception {
        ...
        final Configuration config = TestHelper.defaultConfig()
                .with(SqlServerConnectorConfig.SNAPSHOT_MODE, SnapshotMode.INITIAL)
                .with(SqlServerConnectorConfig.TABLE_BLACKLIST, "dbo.tablea").build();
        connection.execute("INSERT INTO tableb VALUES(1, 'b')");
    ...
    public void blacklistColumnWhenCdcColumnsDoNotMatchWithOriginalSnapshot() throws Exception {
        ...
        final Configuration config = TestHelper.defaultConfig()
                .with(SqlServerConnectorConfig.SNAPSHOT_MODE, SnapshotMode.SCHEMA_ONLY)
                .with(SqlServerConnectorConfig.COLUMN_BLACKLIST, "dbo.table_a.blacklisted_column").build();
        ...
        Schema expectedSchemaA = SchemaBuilder.struct().optional().name("server1.dbo.table_a.Value")
                .field("id", Schema.INT32_SCHEMA).field("name", Schema.OPTIONAL_STRING_SCHEMA)
                .field("amount", Schema.OPTIONAL_INT32_SCHEMA).build();
        ...
        SourceRecordAssert.assertThat(tableA.get(0)).valueAfterFieldIsEqualTo(expectedValueA)
    ...
    public void blacklistColumn() throws Exception {
        ...
        final Configuration config = TestHelper.defaultConfig()
                .with(SqlServerConnectorConfig.SNAPSHOT_MODE, SnapshotMode.SCHEMA_ONLY)
                .with(SqlServerConnectorConfig.COLUMN_BLACKLIST, "dbo.blacklist_column_table_a.amount").build();
        ...
        Schema expectedSchemaA = SchemaBuilder.struct().optional().name("server1.dbo.blacklist_column_table_a.Value")
        ...
        Schema expectedSchemaB = SchemaBuilder.struct().optional().name("server1.dbo.blacklist_column_table_b.Value")
                .field("id", Schema.INT32_SCHEMA).field("name", Schema.OPTIONAL_STRING_SCHEMA)
                .field("amount", Schema.OPTIONAL_INT32_SCHEMA).build();
        ...
        SourceRecordAssert.assertThat(tableB.get(0)).valueAfterFieldIsEqualTo(expectedValueB)
    ...
    public void shouldPropagateDatabaseDriverProperties() throws Exception {
        final Configuration config = TestHelper.defaultConfig()
                .with(SqlServerConnectorConfig.SNAPSHOT_MODE, SnapshotMode.SCHEMA_ONLY)
                .with("database.applicationName", "Debezium App DBZ-964").build();
        ...
        connection.query("select count(1) from sys.dm_exec_sessions where program_name = 'Debezium App DBZ-964'",
                rs -> {
                    rs.next();
    ...
    private void restartInTheMiddleOfTx(boolean restartJustAfterSnapshot, boolean afterStreaming) throws Exception {
        ...
        if (afterStreaming) {
            ...
            final List<SchemaAndValueField> expectedRow = Arrays.asList(
                    ...
                    new SchemaAndValueField("cola", Schema.OPTIONAL_STRING_SCHEMA, "-a"));
            assertRecord(((Struct) records.allRecordsInOrder().get(0).value()).getStruct(Envelope.FieldName.AFTER),
                    expectedRow);
        }
    ...
    public void testEmptySchemaWarningAfterApplyingFilters() throws Exception {
        ...
        Configuration config = TestHelper.defaultConfig()
                .with(SqlServerConnectorConfig.SNAPSHOT_MODE, SnapshotMode.INITIAL)
                .with(SqlServerConnectorConfig.TABLE_WHITELIST, "my_products").build();
    ...
    public void keylessTable() throws Exception {
        ...
        final Configuration config = TestHelper.defaultConfig()
                .with(SqlServerConnectorConfig.SNAPSHOT_MODE, SnapshotMode.INITIAL)
                .with(SqlServerConnectorConfig.TABLE_WHITELIST, "dbo.keyless").build();
    ...
    public void shouldRewriteIdentityKey() throws InterruptedException, SQLException {
        ...
        final Configuration config = TestHelper.defaultConfig()
                ...
                .with(SqlServerConnectorConfig.MSG_KEY_COLUMNS, "(.*).keyless:id").build();
