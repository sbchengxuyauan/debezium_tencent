...
public class SQLServerNumericColumnIT extends AbstractConnectorTest {
    ...
    /**
     * Create 2 Tables. Each table has 4 columns cola: Decimal(8,4) type with 8 precision and 4 scale colb: Decimal -
     * Default precision(18) and default scale(0) colc: numeric(7,1) - 7 precision and 1 scale cold: numeric- Default
     * precision(18) and default scale(0)
     *
     * @throws SQLException
     */
    @Before
    ...
    /**
     * Insert 1 Record into tablenuma with {@code DecimalHandlingMode.STRING} mode Assertions: - Connector is running -
     * 1 Record are streamed out of cdc - Assert cola, colb, colc, cold are exactly equal to the input values.
     *
     * @throws Exception
     */
    @Test
    ...
    /**
     * Insert 1 Record into tablenumb with {@code DecimalHandlingMode.DOUBLE} mode Assertions: - Connector is running -
     * 1 Record are streamed out of cdc - Assert cola, colb, colc, cold are exactly equal to the input values in double
     * format
     *
     * @throws Exception
     */
    ...
    /**
     * Insert 1 Record into tablenumc with {@code DecimalHandlingMode.PRECISE} mode Assertions: - Connector is running -
     * 1 Record are streamed out of cdc - Assert cola, colb, colc, cold are bytes
     *
     * @throws Exception
     */
    @Test
